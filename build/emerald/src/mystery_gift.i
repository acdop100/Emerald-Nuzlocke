...
void task00_mystery_gift(u8 taskId)
{
    ...
    case 8:
        ...
        break;
    case 9:
        switch ((u32)mevent_message_print_and_prompt_yes_no(&data->textState, &data->curPromptWindowId, 0, mevent_client_get_buffer()))
        {
        case 0:
    ...
    case 10:
        ...
        break;
    case 11:
        switch ((u32)mevent_message_print_and_prompt_yes_no(&data->textState, &data->curPromptWindowId, 0, gText_ThrowAwayWonderCard))
        {
        case 0:
        ...
        break;
    case 12:
        switch ((u32)mevent_message_print_and_prompt_yes_no(&data->textState, &data->curPromptWindowId, 0, gText_HaventReceivedCardsGift))
        {
        case 0:
            mevent_client_set_param(0);
            mevent_client_inc_flag();
