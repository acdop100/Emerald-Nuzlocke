...
__attribute__((section("ewram_data"))) struct LinkPlayerEventObject gLinkPlayerEventObjects[4] = {0};
...
void Overworld_ResetStateAfterFly(void)
{
    ...
    FlagClear(((0x500 + 0x356 + 0xA) + 0x2B));
    FlagClear(((0x500 + 0x356 + 0xA) + 0x2D));
    FlagClear(((0x500 + 0x356 + 0xA) + 0x2C));
    FlagClear(((0x500 + 0x356 + 0xA) + 0x29));
    FlagClear(((0x500 + 0x356 + 0xA) + 0x28));
}
...
void LoadEventObjTemplatesFromHeader(void)
{
    ...
    CpuSet(gMapHeader.events->eventObjects, gSaveBlock1Ptr->eventObjectTemplates, 0x04000000 | ((gMapHeader.events->eventObjectCount * sizeof(struct EventObjectTemplate))/(32/8) & 0x1FFFFF))
...
{
    if (mapType != 8 && FlagGet(((0x500 + 0x356 + 0xA) + 0x2D)))
...
{
    if (FlagGet(((0x500 + 0x356 + 0xA) + 0x2D)) && mapType == 6)
        return 4;
...
void SetDefaultFlashLevel(void)
{
    ...
    else if (FlagGet(((0x500 + 0x356 + 0xA) + 0x28)))
...
{
    if (!FlagGet(((0x500 + 0x356 + 0xA) + 0x2A)))
        return 0;
    if (warp->mapGroup == 0)
    {
        switch (warp->mapNum)
...
void TryFadeOutOldMapMusic(void)
{
    ...
    if (FlagGet(0x4001) != 1 && warpMusic != GetCurrentMapMusic())
    {
        if (currentMusic == 365
            && VarGet(0x40CA) == 2
...
{
    if ((gMapHeader.flags & 0xF8) == 8 && SecretBaseMapPopupEnabled() == 1)
        ShowMapNamePopup();
    sub_80AF3C8();
}
...
static void SpawnLinkPlayerEventObject(u8 linkPlayerId, s16 x, s16 y, u8 a4)
{
    ...
    linkPlayerEventObj->movementMode = 0;
...
static void SetPlayerFacingDirection(u8 linkPlayerId, u8 facing)
{
    ...
    if (linkPlayerEventObj->active)
    {
        ...
        else
        {
            ...
            gMovementStatusHandler[gLinkPlayerMovementModes[linkPlayerEventObj->movementMode](linkPlayerEventObj, eventObj, facing)](linkPlayerEventObj, eventObj);
...
static void MovementStatusHandler_TryAdvanceScript(struct LinkPlayerEventObject *linkPlayerEventObj, struct EventObject *eventObj)
{
    ...
    linkPlayerEventObj->movementMode = 1;
    ...
    if (!eventObj->directionSequenceIndex)
    {
        ...
        linkPlayerEventObj->movementMode = 2;
    }
}
...
static void SpriteCB_LinkPlayer(struct Sprite *sprite)
{
    ...
    if (!linkPlayerEventObj->movementMode != 0)
