...
static const u16 sGoldSymbolFlags[] = {
    ((0x500 + 0x356 + 0xA) + 0x65),
    ((0x500 + 0x356 + 0xA) + 0x67),
    ((0x500 + 0x356 + 0xA) + 0x69),
    ((0x500 + 0x356 + 0xA) + 0x6B),
    ((0x500 + 0x356 + 0xA) + 0x6D),
    ((0x500 + 0x356 + 0xA) + 0x6F),
    ((0x500 + 0x356 + 0xA) + 0x71)
};

static const u16 sSilverSymbolFlags[] = {
    ((0x500 + 0x356 + 0xA) + 0x64),
    ((0x500 + 0x356 + 0xA) + 0x66),
    ((0x500 + 0x356 + 0xA) + 0x68),
    ((0x500 + 0x356 + 0xA) + 0x6A),
    ((0x500 + 0x356 + 0xA) + 0x6C),
    ((0x500 + 0x356 + 0xA) + 0x6E),
    ((0x500 + 0x356 + 0xA) + 0x70)
};
...
u8 FindAnyTVShowOnTheAir(void)
{
    ...
    if (gSaveBlock1Ptr->outbreakPokemonSpecies != 0 && gSaveBlock1Ptr->tvShows[response].common.kind == TVSHOW_MASS_OUTBREAK)
    {
...
void UpdateTVScreensOnMap(int width, int height)
{
    ...
    switch (CheckForBigMovieOrEmergencyNewsOnTV())
    {
        ...
        default:
            ...
            else if (FlagGet(((0x500 + 0x356 + 0xA) + 0x32)) && (FindAnyTVShowOnTheAir() != 0xFF || FindAnyTVNewsOnTheAir() != 0xFF || IsTVShowInSearchOfTrainersAiring()))
            {
                FlagClear(((0x500 + 0x356 + 0xA) + 0x31));
                SetTVMetatilesOnMap(width, height, 0x3);
            }
            break;
    }
...
u8 FindFirstActiveTVShowThatIsNotAMassOutbreak(void)
{
    ...
    {
        if (gSaveBlock1Ptr->tvShows[i].common.kind != 0 && gSaveBlock1Ptr->tvShows[i].common.kind != TVSHOW_MASS_OUTBREAK && gSaveBlock1Ptr->tvShows[i].common.active == 1)
        {
            return i;
        }
    }
...
u8 special_0x4a(void)
{
    ...
    if (tvShow->common.kind == TVSHOW_MASS_OUTBREAK && gSaveBlock1Ptr->outbreakPokemonSpecies != 0)
    {
        return FindFirstActiveTVShowThatIsNotAMassOutbreak();
    }
...
void PutPokemonTodayCaughtOnAir(void)
{
    ...
    else
    {
        ...
        if (!TV_BernoulliTrial(0xFFFF * (1) / (1)) && StringCompare(gSpeciesNames[gBattleResults.caughtMonSpecies], gBattleResults.caughtMonNick))
        {
            ...
            if (sCurTVShowSlot != -1 && HasMixableShowAlreadyBeenSpawnedWithPlayerID(TVSHOW_POKEMON_TODAY_CAUGHT, 0) != 1)
            {
                for (i = 0; i < 11; i ++)
                {
...
void PutPokemonTodayFailedOnTheAir(void)
{
    ...
    if (!TV_BernoulliTrial(0xFFFF * (1) / (1)))
    {
        ...
        {
            sCurTVShowSlot = FindEmptyTVSlotBeyondFirstFiveShowsOfArray(gSaveBlock1Ptr->tvShows);
            if (sCurTVShowSlot != -1 && HasMixableShowAlreadyBeenSpawnedWithPlayerID(TVSHOW_POKEMON_TODAY_FAILED, 0) != 1)
            {
                show = &gSaveBlock1Ptr->tvShows[sCurTVShowSlot];
...
static void InterviewAfter_BravoTrainerBattleTowerProfile(void)
{
    ...
    if (show->bravoTrainerTower.language == 1 || gSaveBlock2Ptr->frontier.field_BEB == 1)
    {
...
void SaveRecordedItemPurchasesForTVShow(void)
{
    ...
    {
        sCurTVShowSlot = FindEmptyTVSlotBeyondFirstFiveShowsOfArray(gSaveBlock1Ptr->tvShows);
        if (sCurTVShowSlot != -1 && HasMixableShowAlreadyBeenSpawnedWithPlayerID(TVSHOW_SMART_SHOPPER, 0) != 1)
        {
...
static void sub_80ED8B4(u16 days)
{
    ...
    if (gSaveBlock1Ptr->outbreakPokemonSpecies == 0)
    {
        for (i = 0; i < 24; i ++)
        {
            if (gSaveBlock1Ptr->tvShows[i].massOutbreak.kind == TVSHOW_MASS_OUTBREAK && gSaveBlock1Ptr->tvShows[i].massOutbreak.active == 1)
            {
...
void PutFishingAdviceShowOnTheAir(void)
{
    ...
    sCurTVShowSlot = FindEmptyTVSlotBeyondFirstFiveShowsOfArray(gSaveBlock1Ptr->tvShows);
    if (sCurTVShowSlot != -1 && HasMixableShowAlreadyBeenSpawnedWithPlayerID(TVSHOW_FISHING_ADVICE, 0) != 1)
    {
        show = &gSaveBlock1Ptr->tvShows[sCurTVShowSlot];
...
void sub_80EDA80(void)
{
    ...
    {
        sCurTVShowSlot = FindEmptyTVSlotBeyondFirstFiveShowsOfArray(gSaveBlock1Ptr->tvShows);
        if (sCurTVShowSlot != -1 && HasMixableShowAlreadyBeenSpawnedWithPlayerID(TVSHOW_WORLD_OF_MASTERS, 0) != 1)
        {
            show2 = &gSaveBlock1Ptr->tvShows[sCurTVShowSlot];
...
void sub_80EDB44(void)
{
    ...
    HasMixableShowAlreadyBeenSpawnedWithPlayerID(TVSHOW_TODAYS_RIVAL_TRAINER, 1);
    sCurTVShowSlot = FindEmptyTVSlotBeyondFirstFiveShowsOfArray(gSaveBlock1Ptr->tvShows);
    if (sCurTVShowSlot != -1)
    {
        show = &gSaveBlock1Ptr->tvShows[sCurTVShowSlot];
        ...
        for (i = ((0x500 + 0x356 + 0xA) + 7), nBadges = 0; i < ((0x500 + 0x356 + 0xA) + 7) + 8; i ++)
        {
            if (FlagGet(i))
            {
                nBadges ++;
...
void sub_80EDC60(const u16 *words)
{
    ...
    sCurTVShowSlot = FindEmptyTVSlotBeyondFirstFiveShowsOfArray(gSaveBlock1Ptr->tvShows);
    if (sCurTVShowSlot != -1 && HasMixableShowAlreadyBeenSpawnedWithPlayerID(TVSHOW_TREND_WATCHER, 0) != 1)
    {
        show = &gSaveBlock1Ptr->tvShows[sCurTVShowSlot];
...
void sub_80EDCE8(void)
{
    ...
    sCurTVShowSlot = FindEmptyTVSlotBeyondFirstFiveShowsOfArray(gSaveBlock1Ptr->tvShows);
    if (sCurTVShowSlot != -1 && HasMixableShowAlreadyBeenSpawnedWithPlayerID(TVSHOW_TREASURE_INVESTIGATORS, 0) != 1)
    {
        show = &gSaveBlock1Ptr->tvShows[sCurTVShowSlot];
...
void AlertTVOfNewCoinTotal(u16 nCoinsPaidOut)
{
    ...
    sCurTVShowSlot = FindEmptyTVSlotBeyondFirstFiveShowsOfArray(gSaveBlock1Ptr->tvShows);
    if (sCurTVShowSlot != -1 && HasMixableShowAlreadyBeenSpawnedWithPlayerID(TVSHOW_FIND_THAT_GAMER, 0) != 1)
    {
        flag = 0;
...
void TV_PutSecretBaseVisitOnTheAir(void)
{
    ...
    HasMixableShowAlreadyBeenSpawnedWithPlayerID(TVSHOW_SECRET_BASE_VISIT, 1);
    sCurTVShowSlot = FindEmptyTVSlotBeyondFirstFiveShowsOfArray(gSaveBlock1Ptr->tvShows);
    if (sCurTVShowSlot != -1)
    {
        show = &gSaveBlock1Ptr->tvShows[sCurTVShowSlot];
...
void sub_80EE184(void)
{
    ...
    sCurTVShowSlot = FindEmptyTVSlotBeyondFirstFiveShowsOfArray(gSaveBlock1Ptr->tvShows);
    if (sCurTVShowSlot != -1 && HasMixableShowAlreadyBeenSpawnedWithPlayerID(TVSHOW_BREAKING_NEWS, 0) != 1)
    {
        show = &gSaveBlock1Ptr->tvShows[sCurTVShowSlot];
...
void sub_80EE2CC(void)
{
    ...
    sCurTVShowSlot = FindEmptyTVSlotBeyondFirstFiveShowsOfArray(gSaveBlock1Ptr->tvShows);
    if (sCurTVShowSlot != -1 && HasMixableShowAlreadyBeenSpawnedWithPlayerID(TVSHOW_LOTTO_WINNER, 0) != 1)
    {
        show = &gSaveBlock1Ptr->tvShows[sCurTVShowSlot];
...
void sub_80EE35C(u16 foeSpecies, u16 species, u8 moveIdx, const u16 *movePtr, u16 betterMove)
{
    ...
    sCurTVShowSlot = FindEmptyTVSlotBeyondFirstFiveShowsOfArray(gSaveBlock1Ptr->tvShows);
    if (sCurTVShowSlot != -1 && HasMixableShowAlreadyBeenSpawnedWithPlayerID(TVSHOW_BATTLE_SEMINAR, 0) != 1)
    {
        show = &gSaveBlock1Ptr->tvShows[sCurTVShowSlot];
...
void sub_80EE44C(u8 nMonsCaught, u8 nPkblkUsed)
{
    ...
    sCurTVShowSlot = FindEmptyTVSlotBeyondFirstFiveShowsOfArray(gSaveBlock1Ptr->tvShows);
    if (sCurTVShowSlot != -1 && HasMixableShowAlreadyBeenSpawnedWithPlayerID(TVSHOW_SAFARI_FAN_CLUB, 0) != 1)
    {
        show = &gSaveBlock1Ptr->tvShows[sCurTVShowSlot];
...
void sub_80EE4DC(struct Pokemon *pokemon, u8 ribbonMonDataIdx)
{
    ...
    sCurTVShowSlot = FindEmptyTVSlotBeyondFirstFiveShowsOfArray(gSaveBlock1Ptr->tvShows);
    if (sCurTVShowSlot != -1 && HasMixableShowAlreadyBeenSpawnedWithPlayerID(TVSHOW_CUTIES, 0) != 1)
    {
        show = &gSaveBlock1Ptr->tvShows[sCurTVShowSlot];
...
void sub_80EE72C(void)
{
    ...
    sCurTVShowSlot = FindEmptyTVSlotBeyondFirstFiveShowsOfArray(gSaveBlock1Ptr->tvShows);
    if (sCurTVShowSlot != -1 && HasMixableShowAlreadyBeenSpawnedWithPlayerID(TVSHOW_TRAINER_FAN_CLUB, 0) != 1)
    {
        show = &gSaveBlock1Ptr->tvShows[sCurTVShowSlot];
...
bool8 sub_80EE818(void)
{
    ...
    if (HasMixableShowAlreadyBeenSpawnedWithPlayerID(TVSHOW_FRONTIER, 0) == 1)
    {
...
void sub_80EEA70(void)
{
    ...
    if (HasMixableShowAlreadyBeenSpawnedWithPlayerID(TVSHOW_SECRET_BASE_SECRETS, 0) != 1)
    {
        sCurTVShowSlot = FindEmptyTVSlotBeyondFirstFiveShowsOfArray(gSaveBlock1Ptr->tvShows);
        if (sCurTVShowSlot != -1)
        {
...
static void sub_80EEBF4(u8 actionIdx)
{
    ...
    HasMixableShowAlreadyBeenSpawnedWithPlayerID(TVSHOW_NUMBER_ONE, 1);
    sCurTVShowSlot = FindEmptyTVSlotBeyondFirstFiveShowsOfArray(gSaveBlock1Ptr->tvShows);
    if (sCurTVShowSlot != -1)
    {
        show = &gSaveBlock1Ptr->tvShows[sCurTVShowSlot];
...
u8 FindAnyTVNewsOnTheAir(void)
{
    ...
    for (i = 0; i < 16; i ++)
    {
        if (gSaveBlock1Ptr->pokeNews[i].kind != POKENEWS_NONE && gSaveBlock1Ptr->pokeNews[i].state == 1 && gSaveBlock1Ptr->pokeNews[i].days < 3)
        {
            return i;
        }
    }
...
static void sub_80EF120(u16 days)
{
    ...
    for (i = 0; i < 16; i ++)
    {
        if (gSaveBlock1Ptr->pokeNews[i].kind != POKENEWS_NONE)
        {
            ...
            {
                if (gSaveBlock1Ptr->pokeNews[i].state == 0 && FlagGet(((0x500 + 0x356 + 0xA) + 4)) == 1)
                {
...
u8 CheckForBigMovieOrEmergencyNewsOnTV(void)
{
    ...
    if (FlagGet(((0x500 + 0x356 + 0xA) + 0x5D)) == 1)
    {
        return 1;
    }
    if (FlagGet(((0x500 + 0x356 + 0xA) + 0x30)) == 1)
    {
        return 2;
    }
    return 1;
...
static void sub_80F0B64(void)
{
    ...
    if (FlagGet(((0x500 + 0x356 + 0xA) + 4)) != 1)
    {
        for (i = 0; i < 24; i ++)
        {
...
static void DoTVShowTodaysRivalTrainer(void)
{
    ...
    switch (state)
    {
        ...
        case 1:
            ...
            if (FlagGet(((0x500 + 0x356 + 0xA) + 0x48)))
            {
