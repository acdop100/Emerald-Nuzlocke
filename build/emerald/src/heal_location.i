...
{
    {((1 | (1 << 8)) >> 8), ((1 | (1 << 8)) & 0xFF), 4, 2},
    {((3 | (1 << 8)) >> 8), ((3 | (1 << 8)) & 0xFF), 4, 2},
    {((0 | (0 << 8)) >> 8), ((0 | (0 << 8)) & 0xFF), 20, 17},
    {((1 | (0 << 8)) >> 8), ((1 | (0 << 8)) & 0xFF), 19, 20},
    {((2 | (0 << 8)) >> 8), ((2 | (0 << 8)) & 0xFF), 22, 6},
    {((3 | (0 << 8)) >> 8), ((3 | (0 << 8)) & 0xFF), 16, 39},
    {((4 | (0 << 8)) >> 8), ((4 | (0 << 8)) & 0xFF), 5, 7},
    {((5 | (0 << 8)) >> 8), ((5 | (0 << 8)) & 0xFF), 24, 15},
    {((6 | (0 << 8)) >> 8), ((6 | (0 << 8)) & 0xFF), 28, 17},
    {((7 | (0 << 8)) >> 8), ((7 | (0 << 8)) & 0xFF), 43, 32},
    {((8 | (0 << 8)) >> 8), ((8 | (0 << 8)) & 0xFF), 27, 49},
    {((9 | (0 << 8)) >> 8), ((9 | (0 << 8)) & 0xFF), 5, 9},
    {((9 | (0 << 8)) >> 8), ((9 | (0 << 8)) & 0xFF), 14, 9},
    {((10 | (0 << 8)) >> 8), ((10 | (0 << 8)) & 0xFF), 6, 17},
    {((11 | (0 << 8)) >> 8), ((11 | (0 << 8)) & 0xFF), 2, 11},
    {((12 | (0 << 8)) >> 8), ((12 | (0 << 8)) & 0xFF), 9, 7},
    {((13 | (0 << 8)) >> 8), ((13 | (0 << 8)) & 0xFF), 14, 8},
    {((14 | (0 << 8)) >> 8), ((14 | (0 << 8)) & 0xFF), 16, 4},
    {((15 | (0 << 8)) >> 8), ((15 | (0 << 8)) & 0xFF), 8, 16},
    {((8 | (0 << 8)) >> 8), ((8 | (0 << 8)) & 0xFF), 18, 6},
    {((9 | (26 << 8)) >> 8), ((9 | (26 << 8)) & 0xFF), 15, 20},
    {((14 | (26 << 8)) >> 8), ((14 | (26 << 8)) & 0xFF), 3, 52},
};
