...
u8 CastformDataTypeChange(u8 battler)
{
    ...
    if (!((!(AbilityBattleEffects(0x13, 0, 13, 0, 0)) && !(AbilityBattleEffects(0x13, 0, 77, 0, 0)))) && !((gBattleMons[battler].type1 == 0x00 || gBattleMons[battler].type2 == 0x00)))
    {
        { gBattleMons[battler].type1 = 0x00; gBattleMons[battler].type2 = 0x00; };
        return CASTFORM_TO_NORMAL;
    }
    if (!((!(AbilityBattleEffects(0x13, 0, 13, 0, 0)) && !(AbilityBattleEffects(0x13, 0, 77, 0, 0)))))
        return CASTFORM_NO_CHANGE;
    if (!(gBattleWeather & (((1 << 0) | (1 << 1) | (1 << 2)) | ((1 << 5) | (1 << 6)) | ((1 << 7)))) && !((gBattleMons[battler].type1 == 0x00 || gBattleMons[battler].type2 == 0x00)))
    {
        { gBattleMons[battler].type1 = 0x00; gBattleMons[battler].type2 = 0x00; };
        formChange = CASTFORM_TO_NORMAL;
    }
    if (gBattleWeather & ((1 << 5) | (1 << 6)) && !((gBattleMons[battler].type1 == 0x0a || gBattleMons[battler].type2 == 0x0a)))
    {
        { gBattleMons[battler].type1 = 0x0a; gBattleMons[battler].type2 = 0x0a; };
        formChange = CASTFORM_TO_FIRE;
    }
    if (gBattleWeather & ((1 << 0) | (1 << 1) | (1 << 2)) && !((gBattleMons[battler].type1 == 0x0b || gBattleMons[battler].type2 == 0x0b)))
    {
        { gBattleMons[battler].type1 = 0x0b; gBattleMons[battler].type2 = 0x0b; };
        formChange = CASTFORM_TO_WATER;
    }
    if (gBattleWeather & ((1 << 7)) && !((gBattleMons[battler].type1 == 0x0f || gBattleMons[battler].type2 == 0x0f)))
    {
        { gBattleMons[battler].type1 = 0x0f; gBattleMons[battler].type2 = 0x0f; };
        ...
        case 0x3:
            if (move)
            {
                ...
                case 11:
                    ...
                    break;
                case 18:
                    if (moveType == 0x0a && !(gBattleMons[battler].status1 & 0x20))
                    {
    ...
    case 1:
        if (gBattleMons[battlerId].hp)
        {
            ...
            case 10:
                if (gBattleMons[battlerId].hp <= gBattleMons[battlerId].maxHP / 2 && !moveTurn)
                {
                    { gBattleTextBuff1[0] = 0xFD; gBattleTextBuff1[1] = 8; gBattleTextBuff1[2] = FLAVOR_SPICY; gBattleTextBuff1[3] = 0xFF; };
            ...
            case 11:
                if (gBattleMons[battlerId].hp <= gBattleMons[battlerId].maxHP / 2 && !moveTurn)
                {
                    { gBattleTextBuff1[0] = 0xFD; gBattleTextBuff1[1] = 8; gBattleTextBuff1[2] = FLAVOR_DRY; gBattleTextBuff1[3] = 0xFF; };
            ...
            case 12:
                if (gBattleMons[battlerId].hp <= gBattleMons[battlerId].maxHP / 2 && !moveTurn)
                {
                    { gBattleTextBuff1[0] = 0xFD; gBattleTextBuff1[1] = 8; gBattleTextBuff1[2] = FLAVOR_SWEET; gBattleTextBuff1[3] = 0xFF; };
            ...
            case 13:
                if (gBattleMons[battlerId].hp <= gBattleMons[battlerId].maxHP / 2 && !moveTurn)
                {
                    { gBattleTextBuff1[0] = 0xFD; gBattleTextBuff1[1] = 8; gBattleTextBuff1[2] = FLAVOR_BITTER; gBattleTextBuff1[3] = 0xFF; };
            ...
            case 14:
                if (gBattleMons[battlerId].hp <= gBattleMons[battlerId].maxHP / 2 && !moveTurn)
                {
                    { gBattleTextBuff1[0] = 0xFD; gBattleTextBuff1[1] = 8; gBattleTextBuff1[2] = FLAVOR_SOUR; gBattleTextBuff1[3] = 0xFF; };
...
u8 IsMonDisobedient(void)
{
    ...
    if (HasObedientBitSet(gBattlerAttacker))
    {
        ...
        if (!IsOtherTrainer(gBattleMons[gBattlerAttacker].otId, gBattleMons[gBattlerAttacker].otName))
            return 0;
        if (FlagGet(((0x500 + 0x356 + 0xA) + 0xE)))
            return 0;

        obedienceLevel = 10;

        if (FlagGet(((0x500 + 0x356 + 0xA) + 8)))
            obedienceLevel = 30;
        if (FlagGet(((0x500 + 0x356 + 0xA) + 0xA)))
            obedienceLevel = 50;
        if (FlagGet(((0x500 + 0x356 + 0xA) + 0xC)))
            obedienceLevel = 70;
    }
