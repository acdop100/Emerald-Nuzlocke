...
# 11 "src/pokenav_unk_5.c" 2
# 1 "include/sprite.h" 1
# 12 "src/pokenav_unk_5.c" 2
...
# 13 "src/pokenav_unk_5.c" 2
# 1 "include/task.h" 1
# 14 "src/pokenav_unk_5.c" 2
...
# 15 "src/pokenav_unk_5.c" 2
# 1 "include/window.h" 1
# 16 "src/pokenav_unk_5.c" 2
# 1 "include/constants/songs.h" 1
# 17 "src/pokenav_unk_5.c" 2
...
static u32 sub_81CC6F4(s32 taskState)
{
    ...
    case 0:
        ...
        HideBg(3);
        SetBgMode(1);
        InitBgTemplates(gUnknown_086230D8, (size_t)(sizeof(gUnknown_086230D8) / sizeof((gUnknown_086230D8)[0])) - 1);
...
{
    int i;
    for (i = 0; i < (size_t)(sizeof(gUnknown_086230F8) / sizeof((gUnknown_086230F8)[0])); i++)
...
static void sub_81CCA1C(struct Pokenav5Struct_2 *state)
{
    ...
    { vu16 tmp = (vu16)(0x1040); CpuSet((void *)&tmp, state->unk18, 0x00000000 | 0x01000000 | ((0x800)/(16/8) & 0x1FFFFF)); };
    ...
    FillWindowPixelBuffer(state->unk8, ((1) | ((1) << 4)));
...
static void sub_81CCB0C(struct Pokenav5Struct_2 *state)
{
    ...
    case MAPSECTYPE_CITY_CANFLY:
        ...
        AddTextPrinterParameterized(state->unk8, 7, regionMap->mapSecName, 0, 1, 0xFF, ((void *)0));
...
{
    struct Pokenav5Struct_2 *state = GetSubstructPtr(4);
    if (taskState < (int)(size_t)(sizeof(gPokenavCityMaps) / sizeof((gPokenavCityMaps)[0])))
    {
...
{
    int i;
    for (i = 0; i < (int)(size_t)(sizeof(gPokenavCityMaps) / sizeof((gPokenavCityMaps)[0])) && (gPokenavCityMaps[i].mapSecId != mapSecId || gPokenavCityMaps[i].index != pos); i++)
        ;

    if (i == (size_t)(sizeof(gPokenavCityMaps) / sizeof((gPokenavCityMaps)[0])))
        return;
...
static void sub_81CCDE8(struct Pokenav5Struct_2 *state, int mapSecId, int pos)
{
    ...
    while (1)
    {
        ...
        AddTextPrinterParameterized(state->unk8, 7, gStringVar1, 0, i * 16 + 17, 0xFF, ((void *)0));
        i++;
    }
}
