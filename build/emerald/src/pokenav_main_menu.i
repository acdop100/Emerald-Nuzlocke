...
void sub_81C7AC0(s32 a0)
{
    ...
    {
    case 0:
        BeginNormalPaletteFade(structPtr->unk14, -2, 0, 16, ((0) | ((0) << 5) | ((0) << 10)));
        break;
    case 1:
        BeginNormalPaletteFade(structPtr->unk14, -2, 16, 0, ((0) | ((0) << 5) | ((0) << 10)));
        break;
    case 2:
...
static void sub_81C7B74(void)
{
    ...
    CopyWindowToVram(structPtr->unk10, 3);
}
...
void LoadLeftHeaderGfxForIndex(u32 arg0)
{
    if (arg0 < POKENAV_GFX_PARTY_MENU)
        LoadLeftHeaderGfxForMenu(arg0);
    else
        LoadLeftHeaderGfxForSubMenu(arg0 - POKENAV_GFX_PARTY_MENU);
}
...
static void LoadLeftHeaderGfxForMenu(u32 index)
{
    ...
    if (index >= POKENAV_GFX_PARTY_MENU)
        return;
...
static void LoadLeftHeaderGfxForSubMenu(u32 arg0)
{
    ...
    if (arg0 >= POKENAV_GFX_MENUS_END - POKENAV_GFX_PARTY_MENU)
        return;
