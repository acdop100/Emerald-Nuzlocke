...
__attribute__((section("ewram_data"))) static u8 sUnknown_02037619[2] = {0};
...
{
    FlagSet(((0x500 + 0x356 + 0xA) + 1));
    FlagSet(((0x500 + 0x356 + 0xA) + 0));
    FlagSet(((0x500 + 0x356 + 0xA) + 2));
}
...
static void BuildNormalStartMenu(void)
{
    if (FlagGet(((0x500 + 0x356 + 0xA) + 1)) == 1)
    {
        AddStartMenuAction(MENU_ACTION_POKEDEX);
    }
    if (FlagGet(((0x500 + 0x356 + 0xA) + 0)) == 1)
    {
    ...
    if (FlagGet(((0x500 + 0x356 + 0xA) + 2)) == 1)
    {
...
static bool8 StartMenuPlayerNameCallback(void)
{
    if (!gPaletteFade.active)
    {
        ...
        else if (FlagGet(((0x500 + 0x356 + 0xA) + 0x72)))
