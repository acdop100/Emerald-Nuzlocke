...
{
    (*(vu16 *)(0x4000000 + 0x0)) = 0x0000;
    (*(vu16 *)(0x4000000 + 0x10)) = 0x0000;
    (*(vu16 *)(0x4000000 + 0x12)) = 0x0000;
    (*(vu16 *)(0x4000000 + 0x50)) = 0x0000;
    LZ77UnCompVram(gUnknown_08617128[idx].gfx, (void *)(0x6000000 + (0x4000 * (0))));
    LZ77UnCompVram(gUnknown_08617128[idx].tileMap, (void *)(0x6000000 + (0x800 * (31))));
    CpuSet(gUnknown_08617128[idx].pltt, (void *)0x5000000, 0x00000000 | ((0x200)/(16/8) & 0x1FFFFF));
