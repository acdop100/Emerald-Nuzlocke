...
__attribute__((section("ewram_data"))) struct ContestWinner gUnknown_02039F3C = {0};
...
static void sub_80D8B38(u8 taskId)
{
    ...
    case 5:
        ...
        else
        {
            ...
            if ((gContestResources->status)[r6].currMove < 355)
                ...
                StringCopy(gStringVar2, gUnknown_08587F1C[(gContestResources->status)[r6].moveCategory]);
    ...
    case 41:
        ...
        else
        {
            ...
            {
                StringCopy(gStringVar3, gUnknown_08587F08[gContestMoves[(gContestResources->status)[r6].currMove].contestCategory]);
            }
            if (r3 > 0)
            {
                if ((gContestResources->status)[r6].disappointedRepeat)
...
static void sub_80DA3CC(u8 taskId)
{
    if (gTasks[taskId].data[0] == 0)
    {
        u8 r4 = (gContestResources->status)[gContestPlayerMonIndex].attentionLevel;
...
void sub_80DAB8C(u8 contestType, u8 rank)
{
    ...
    if (FlagGet(((0x500 + 0x356 + 0xA) + 4)) && !(gLinkContestFlags & (1 << 0)))
        r7 = 1;
...
static void sub_80DE864(u8 a)
{
    ...
    {
    case 174:
        if (gBaseStats[species].type1 == 0x07 || gBaseStats[species].type2 == 0x07)
            gAnimMoveTurn = 0;
        else
            gAnimMoveTurn = 1;
        break;
