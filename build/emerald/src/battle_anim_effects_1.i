...
# 2186 "src/battle_anim_effects_1.c"
...
# 2388 "src/battle_anim_effects_1.c"
...
# 2430 "src/battle_anim_effects_1.c"
...
# 2628 "src/battle_anim_effects_1.c"
...
# 2918 "src/battle_anim_effects_1.c"
...
void sub_8102BE8(u8 taskId)
{
    ...
    {
        index = (index << 4) + 0x100;
        for (i = 1; i < (size_t)(sizeof(gUnknown_08593020[0]) / sizeof((gUnknown_08593020[0])[0])); i++)
            gPlttBufferFaded[index + i] = gUnknown_08593020[0][i];
    }

    for (j = 1; j < (size_t)(sizeof(gUnknown_08593020) / sizeof((gUnknown_08593020)[0])); j++)
    {
...
{
    u16 i;
    for (i = 1; i < (size_t)(sizeof(gUnknown_08593020) / sizeof((gUnknown_08593020)[0])); i++)
