...
void InitDewfordTrend(void)
{
    ...
    for (i = 0; i < 5; i++)
    {
        gSaveBlock1Ptr->easyChatPairs[i].words[0] = sub_811EE38(0xa);

        if (Random() & 1)
            gSaveBlock1Ptr->easyChatPairs[i].words[1] = sub_811EE38(0xc);
        else
            gSaveBlock1Ptr->easyChatPairs[i].words[1] = sub_811EE38(0xd);
...
bool8 sub_81226D8(u16 *a)
{
    ...
    {
        if (!FlagGet(((0x500 + 0x356 + 0xA) + 0x33)))
        {
            FlagSet(((0x500 + 0x356 + 0xA) + 0x33));
            if (!FlagGet(((0x500 + 0x356 + 0xA) + 0x34)))
            {
