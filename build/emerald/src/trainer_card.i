...
static bool8 HasAllFrontierSymbols(void)
{
    ...
    for (i = 0; i < 7; i++)
    {
        if (!FlagGet(((0x500 + 0x356 + 0xA) + 0x64) + 2 * i) || !FlagGet(((0x500 + 0x356 + 0xA) + 0x65) + 2 * i))
            return 0;
    }
    return 1;
}
...
static void SetPlayerCardData(struct TrainerCard *trainerCard, u8 cardType)
{
    ...
    trainerCard->hasPokedex = FlagGet(((0x500 + 0x356 + 0xA) + 1));
...
static void SetDataFromTrainerCard(void)
{
    ...
    for (i = 0, badgeFlag = ((0x500 + 0x356 + 0xA) + 7); badgeFlag <= ((0x500 + 0x356 + 0xA) + 0xE); badgeFlag++, i++)
    {
...
static void InitBgsAndWindows(void)
{
    ...
    InitBgsFromTemplates(0, gUnknown_0856FAB4, (size_t)(sizeof(gUnknown_0856FAB4) / sizeof((gUnknown_0856FAB4)[0])));
    ChangeBgX(0, 0, 0);
    ChangeBgY(0, 0, 0);
    ChangeBgX(1, 0, 0);
    ChangeBgY(1, 0, 0);
...
static void PrintNameOnCard(void)
{
    ...
    if (sData->cardType == CARD_TYPE_FRLG)
        AddTextPrinterParameterized3(1, 1, 20, 28, gUnknown_0856FB0C, 0xFF, buffer);
    else
        AddTextPrinterParameterized3(1, 1, 16, 33, gUnknown_0856FB0C, 0xFF, buffer);
}
...
static void PrintIdOnCard(void)
{
    ...
    AddTextPrinterParameterized3(1, 1, xPos, top, gUnknown_0856FB0C, 0xFF, buffer);
}
...
static void PrintMoneyOnCard(void)
{
    ...
    if (!sData->isHoenn)
        AddTextPrinterParameterized3(1, 1, 20, 56, gUnknown_0856FB0C, 0xFF, gText_TrainerCardMoney);
    else
        AddTextPrinterParameterized3(1, 1, 16, 57, gUnknown_0856FB0C, 0xFF, gText_TrainerCardMoney);
    ...
    AddTextPrinterParameterized3(1, 1, xOffset, top, gUnknown_0856FB0C, 0xFF, gStringVar4);
}
...
static void PrintPokedexOnCard(void)
{
    s32 xOffset;
    u8 top;
    if (FlagGet(((0x500 + 0x356 + 0xA) + 1)))
    {
        if (!sData->isHoenn)
            AddTextPrinterParameterized3(1, 1, 20, 72, gUnknown_0856FB0C, 0xFF, gText_TrainerCardPokedex);
        else
            AddTextPrinterParameterized3(1, 1, 16, 73, gUnknown_0856FB0C, 0xFF, gText_TrainerCardPokedex);
...
static void PrintTimeOnCard(void)
{
    ...
    if (!sData->isHoenn)
        AddTextPrinterParameterized3(1, 1, 20, 88, gUnknown_0856FB0C, 0xFF, gText_TrainerCardTime);
    else
        AddTextPrinterParameterized3(1, 1, 16, 89, gUnknown_0856FB0C, 0xFF, gText_TrainerCardTime);
    ...
    FillWindowPixelRect(1, ((0) | ((0) << 4)), r7, r4, r10, 15);
    ConvertIntToDecimalStringN(gStringVar4, hours, 1, 3);
    AddTextPrinterParameterized3(1, 1, r7, r4, gUnknown_0856FB0C, 0xFF, gStringVar4);
    r7 += 18;
    AddTextPrinterParameterized3(1, 1, r7, r4, gUnknown_0856FB40[sData->var_7], 0xFF, gText_Colon2);
    r7 += width;
...
static void PrintProfilePhraseOnCard(void)
{
    if (sData->isLink)
    {
        AddTextPrinterParameterized3(1, 1, 8, gUnknown_0856FB48[sData->isHoenn], gUnknown_0856FB0C, 0xFF, sData->var_19[0]);
        AddTextPrinterParameterized3(1, 1, GetStringWidth(1, sData->var_19[0], 0) + 14, gUnknown_0856FB48[sData->isHoenn], gUnknown_0856FB0C, 0xFF, sData->var_19[1]);
        AddTextPrinterParameterized3(1, 1, 8, gUnknown_0856FB4A[sData->isHoenn], gUnknown_0856FB0C, 0xFF, sData->var_19[2]);
        AddTextPrinterParameterized3(1, 1, GetStringWidth(1, sData->var_19[2], 0) + 14, gUnknown_0856FB4A[sData->isHoenn], gUnknown_0856FB0C, 0xFF, sData->var_19[3]);
    }
}
...
{
    if (!sData->isHoenn)
        AddTextPrinterParameterized3(1, 1, 136, 9, gUnknown_0856FB0C, 0xFF, sData->var_4D);
    else
        AddTextPrinterParameterized3(1, 1, GetStringRightAlignXOffset(1, sData->var_4D, 216), 9, gUnknown_0856FB0C, 0xFF, sData->var_4D);
}
...
static void PrintString(u8 top, const u8* str1, u8* str2, const u8* color)
{
    AddTextPrinterParameterized3(1, 1, gUnknown_0856FB55[sData->isHoenn], top * 16 + 33, gUnknown_0856FB0C, 0xFF, str1);
    AddTextPrinterParameterized3(1, 1, GetStringRightAlignXOffset(1, str2, gUnknown_0856FB57[sData->isHoenn]), top * 16 + 33, color, 0xFF, str2);
}
