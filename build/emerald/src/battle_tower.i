...
{
    {0x47, gUnknown_085DD118},
    {0x2b, gUnknown_085DD12C},
    {0x0, gUnknown_085DD140},
    {0x14, gUnknown_085DD154},
    {0x2d, gUnknown_085DD168},
    {0x13, gUnknown_085DD17C},
    {0x2f, gUnknown_085DD190},
    {0x43, gUnknown_085DD1A4},
    {0x26, gUnknown_085DD1B8},
    {0x15, gUnknown_085DD1CC},
    {0xa, gUnknown_085DD1E0},
    {0x10, gUnknown_085DD1F4},
    {0xc, gUnknown_085DD208},
    {0x42, gUnknown_085DD21C},
    {0x31, gUnknown_085DD230},
    {0x30, gUnknown_085DD244},
    {0x36, gUnknown_085DD258},
    {0x2e, gUnknown_085DD26C},
    {0x11, gUnknown_085DD280},
    {0x19, gUnknown_085DD294},
    {0x20, gUnknown_085DD2A8},
    {0x29, gUnknown_085DD2BC},
    {0x9, gUnknown_085DD2D0},
    {0x16, gUnknown_085DD2E4},
    {0x34, gUnknown_085DD2F8},
    {0x4, gUnknown_085DD30C},
    {0x35, gUnknown_085DD320},
    {0x37, gUnknown_085DD334},
    {0x1d, gUnknown_085DD348},
    {0x3a, gUnknown_085DD35C},
    {0x5, gUnknown_085DD370},
    {0x44, gUnknown_085DD384},
    {0x45, gUnknown_085DD398},
    {0xd, gUnknown_085DD3AC},
    {0xe, gUnknown_085DD3C0},
    {0x3, gUnknown_085DD3D4},
    {0x12, gUnknown_085DD3E8},
    {0x17, gUnknown_085DD3FC},
    {0x1a, gUnknown_085DD410},
    {0x1b, gUnknown_085DD424},
    {0x1c, gUnknown_085DD438},
    {0x1e, gUnknown_085DD44C},
    {0x1f, gUnknown_085DD460},
    {0x27, gUnknown_085DD474},
    {0x2, gUnknown_085DD488},
    {0x2a, gUnknown_085DD49C},
    {0x38, gUnknown_085DD4B0},
    {0x32, gUnknown_085DD4C4},
    {0x33, gUnknown_085DD4D8},
    {0x7, gUnknown_085DD4EC}
};
...
static void sub_81625B4(u8 challengeNum, u8 battleNum, u16 *trainerIdPtr, u8 *arg3)
{
    u16 trainerId, count;
...
static void FillTrainerParty(u16 trainerId, u8 firstMonId, u8 monCount)
{
    ...
    while (i != monCount)
    {
        ...
        {
            if (GetMonData(&gEnemyParty[j], 11, ((void *)0)) == gFacilityTrainerMons[monSetId].species)
                break;
        }
        if (j != i + firstMonId)
            continue;
        ...
        for (j = 0; j < i + firstMonId; j++)
        {
            if (GetMonData(&gEnemyParty[j], 12, ((void *)0)) != 0
             && GetMonData(&gEnemyParty[j], 12, ((void *)0)) == gBattleFrontierHeldItems[gFacilityTrainerMons[monSetId].itemTableId])
                break;
        }
        if (j != i + firstMonId)
            continue;
        ...
        for (j = 0; j < 4; j++)
        {
            ...
            if (gFacilityTrainerMons[monSetId].moves[j] == 218)
                friendship = 0;
        }

        SetMonData(&gEnemyParty[i + firstMonId], 32, &friendship);
        SetMonData(&gEnemyParty[i + firstMonId], 12, &gBattleFrontierHeldItems[gFacilityTrainerMons[monSetId].itemTableId]);
...
static void FillFactoryFrontierTrainerParty(u16 trainerId, u8 firstMonId)
{
    ...
    for (i = 0; i < 3; i++)
    {
        ...
        SetMonData(&gEnemyParty[firstMonId + i], 32, &friendship);
        SetMonData(&gEnemyParty[firstMonId + i], 12, &gBattleFrontierHeldItems[gFacilityTrainerMons[monSetId].itemTableId]);
    }
}
...
static void sub_8163914(void)
{
    ...
    if (trainerId == 500)
        ...
        CopyFriendsApprenticeChallengeText(trainerId - 400);
}
...
static void sub_8164828(void)
{
    ...
    for (arrId = 0; arrId < (size_t)(sizeof(gUnknown_085DD500) / sizeof((gUnknown_085DD500)[0])); arrId++)
    {
    ...
    {
        u8 id = gSaveBlock2Ptr->apprentices[trainerId - 400].id;
...
static void sub_8164E04(void)
{
    ...
    gSaveBlock2Ptr->frontier.field_BD6 = GetMonData(&gEnemyParty[gBattlerPartyIndexes[1]], 11, ((void *)0));
    gSaveBlock2Ptr->frontier.field_BD4 = GetMonData(&gPlayerParty[gBattlerPartyIndexes[0]], 11, ((void *)0));
    for (i = 0; i < 10 + 1; i++)
...
{
    u8 sp[(size_t)(sizeof(gUnknown_085DFA42) / sizeof((gUnknown_085DFA42)[0]))];
    memcpy(sp, gUnknown_085DFA42, sizeof(gUnknown_085DFA42));

    if (battleMode < (size_t)(sizeof(gUnknown_085DFA42) / sizeof((gUnknown_085DFA42)[0])))
...
static void FillPartnerParty(u16 trainerId)
{
    ...
    if (trainerId == 3075)
    {
        for (i = 0; i < 3; i++)
        {
            ...
            CreateMon(&gPlayerParty[3 + i],
                      ...
                      1, 61226);
            for (j = 0; j < 6; j++)
                SetMonData(&gPlayerParty[3 + i], 26 + j, &sStevenMons[i].evs[j]);
            for (j = 0; j < 4; j++)
                SetMonMoveSlot(&gPlayerParty[3 + i], sStevenMons[i].moves[j], j);
            SetMonData(&gPlayerParty[3 + i], 7, gTrainers[804].trainerName);
            j = 0;
            SetMonData(&gPlayerParty[3 + i], 49, &j);
    ...
    else if (trainerId < 300)
    {
        ...
        for (i = 0; i < 2; i++)
        {
            ...
            SetMonData(&gPlayerParty[3 + i], 32, &friendship);
            SetMonData(&gPlayerParty[3 + i], 12, &gBattleFrontierHeldItems[gFacilityTrainerMons[monSetId].itemTableId]);
            for (j = 0; j < 7 + 1; j++)
                trainerName[j] = gFacilityTrainers[trainerId].trainerName[j];
            SetMonData(&gPlayerParty[3 + i], 7, &trainerName);
    ...
    else if (trainerId < 400)
    {
        ...
        for (i = 0; i < 2; i++)
        {
            ...
            CreateBattleTowerMon2(&gPlayerParty[3 + i], &monData, 1);
            SetMonData(&gPlayerParty[3 + i], 7, trainerName);
...
{
    u8 level = 30;
    u32 tentFacility = VarGet(0x40CF);
