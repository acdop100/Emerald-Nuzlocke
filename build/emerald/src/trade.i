...
static __attribute__((section("ewram_data"))) u8 *gUnknown_02032184 = ((void *)0);
static __attribute__((section("ewram_data"))) u8 *gUnknown_02032188[14] = {((void *)0)};
__attribute__((section("ewram_data"))) struct MailStruct gUnknown_020321C0[6] = {0};
__attribute__((section("ewram_data"))) u8 gUnknown_02032298[2] = {0};
static __attribute__((section("ewram_data"))) struct {
               ...
               u8 partyCounts[2];
               bool8 tradeMenuOptionsActive[12];
               u8 unk_44;
               u8 unk_45[2][6];
               u8 unk_51[2][6];
               u8 unk_5D[2][6];
...
static void sub_80772A4(void)
{
    ...
    InitBgsFromTemplates(0, gUnknown_0832DEE4, (size_t)(sizeof(gUnknown_0832DEE4) / sizeof((gUnknown_0832DEE4)[0])));
...
static void sub_80773D0(void)
{
    ...
    case 7:
        ...
        for (i = 0; i < gUnknown_0203229C->partyCounts[0]; i++)
        {
            ...
            gUnknown_0203229C->partyIcons[0][i] = CreateMonIcon(GetMonData(mon, 65),
                                                         sub_80D3014,
        ...
        for (i = 0; i < gUnknown_0203229C->partyCounts[1]; i++)
        {
            ...
            gUnknown_0203229C->partyIcons[1][i] = CreateMonIcon(GetMonData(mon, 65, ((void *)0)),
                                                         sub_80D3014,
...
static void sub_8077B74(void)
{
    ...
    case 7:
        ...
        {
            struct Pokemon *mon = &gPlayerParty[i];
            gUnknown_0203229C->partyIcons[0][i] = CreateMonIcon(GetMonData(mon, 65, ((void *)0)),
                                                         sub_80D3014,
                                                         (gTradeMonSpriteCoords[i][0] * 8) + 14,
                                                         (gTradeMonSpriteCoords[i][1] * 8) - 12,
                                                         1,
    ...
    case 13:
        ...
        if (gUnknown_0203229C->tradeMenuCursorPosition < 6)
            ...
            gUnknown_0203229C->tradeMenuCursorPosition = gLastViewedMonIndex + 6;
...
static void sub_807825C(void)
{
    ...
    SetGpuReg(0x18, gUnknown_0203229C->unk_0++);
    SetGpuReg(0x1c, gUnknown_0203229C->unk_1--);
...
static void sub_8078388(void)
{
    ...
    for (i = 0; i < 6; i++)
    {
        ...
        {
            gSprites[gUnknown_0203229C->partyIcons[0][i]].invisible = 0;
            gUnknown_0203229C->tradeMenuOptionsActive[i] = 1;
        }
        else
        {
            gUnknown_0203229C->tradeMenuOptionsActive[i] = 0;
        }

        if (i < gUnknown_0203229C->partyCounts[1])
        {
            gSprites[gUnknown_0203229C->partyIcons[1][i]].invisible = 0;
            gUnknown_0203229C->tradeMenuOptionsActive[i + 6] = 1;
        }
        else
        {
            gUnknown_0203229C->tradeMenuOptionsActive[i + 6] = 0;
        }
    }
...
{
    sub_807A308(gText_IsThisTradeOkay, (void *)((0x6000000 + 0x10000) + (gUnknown_0203229C->unk_72 * 32)), 24);
}
...
static u8 sub_8078C6C(u8 oldPosition, u8 direction)
{
    ...
    for (i = 0; i < 6; i++)
    {
        if (gUnknown_0203229C->tradeMenuOptionsActive[gTradeNextSelectedMonTable[oldPosition][direction][i]] == 1)
        {
...
static void sub_8078DBC(void)
{
    ...
    if (gMain.newKeys & 0x0001)
    {
        ...
        else if (gUnknown_0203229C->tradeMenuCursorPosition == 12)
        {
            ...
            sub_807A308(gUnknown_0832DE94[4], (void *)((0x6000000 + 0x10000) + gUnknown_0203229C->unk_72 * 32), 24);
        }
    }
}
...
static void sub_8078EF8(void)
{
    sub_8079F74();
    gUnknown_0203229C->unk_6F = 0;
    gSprites[gUnknown_0203229C->tradeMenuCursorSpriteIdx].invisible = 0;
    sub_807A308(gUnknown_0832DE94[1], (void *)((0x6000000 + 0x10000) + gUnknown_0203229C->unk_72 * 32), 24);
}
    ...
    switch (Menu_ProcessInputNoWrap())
    {
        ...
        case 1:
            switch (sub_807A5F4(gPlayerParty, gPlayerPartyCount, gUnknown_0203229C->tradeMenuCursorPosition))
            {
                case 0:
                    sub_8078D78();
                    gSprites[gUnknown_0203229C->tradeMenuCursorSpriteIdx].invisible = 1;
                    break;
                case 1:
                    sub_807A048(3, 3);
                    gUnknown_0203229C->unk_6F = 8;
...
static void sub_807905C(void)
{
    if (!gPaletteFade.active)
    {
        ...
        {
            ShowPokemonSummaryScreen(PSS_MODE_UNK1, gEnemyParty, gUnknown_0203229C->tradeMenuCursorPosition - 6, gUnknown_0203229C->partyCounts[1] - 1, sub_8077B74);
        }
        FreeAllWindowBuffers();
    }
}
...
static u8 sub_80790D4(u8 *a0, u8 a1, u8 a2, u8 a3)
{
    ...
    a3 %= 6;
    species = GetMonData(&gEnemyParty[a3], 11);

    if (species == 410 || species == 151)
    {
        if (!GetMonData(&gEnemyParty[a3], 80))
        {
            return 2;
        }
    }
...
{
    if (!sub_801048C(0) && sub_807A09C() == 0)
    {
        sub_800ADF8();
        gUnknown_0203229C->unk_6F = 13;
    }
...
static void sub_80796B4(u8 a0)
{
    ...
    case 1:
        ...
        {
            gSprites[gUnknown_0203229C->partyIcons[0][i + (whichParty * 6)]].invisible = 1;
        }
        ...
        gSprites[gUnknown_0203229C->partyIcons[0][partyIdx + (whichParty * 6)]].invisible = 0;
        gSprites[gUnknown_0203229C->partyIcons[0][partyIdx + (whichParty * 6)]].data[0] = 20;
        gSprites[gUnknown_0203229C->partyIcons[0][partyIdx + (whichParty * 6)]].data[2] = (gTradeMonSpriteCoords[whichParty * 6][0] + gTradeMonSpriteCoords[whichParty * 6 + 1][0]) / 2 * 8 + 14;
        gSprites[gUnknown_0203229C->partyIcons[0][partyIdx + (whichParty * 6)]].data[4] = (gTradeMonSpriteCoords[whichParty * 6][1] * 8) - 12;
        StoreSpriteCallbackInData6(&gSprites[gUnknown_0203229C->partyIcons[0][partyIdx + (whichParty * 6)]], sub_80D3014);
        gUnknown_0203229C->unk_74[a0]++;
        sub_80A6DEC(&gSprites[gUnknown_0203229C->partyIcons[0][partyIdx + (whichParty * 6)]]);
        ...
        break;
    case 2:
        if (gSprites[gUnknown_0203229C->partyIcons[0][partyIdx + (whichParty * 6)]].callback == sub_80D3014)
            gUnknown_0203229C->unk_74[a0] = 3;
        break;
    case 3:
        CopyToBgTilemapBufferRect_ChangePalette(1, gTradeMovesBoxTilemap, whichParty * 15, 0, 15, 17, 0);
        CopyBgTilemapBufferToVram(1);
        gSprites[gUnknown_0203229C->partyIcons[0][partyIdx + (whichParty * 6)]].pos1.x = (gTradeMonSpriteCoords[whichParty * 6][0] + gTradeMonSpriteCoords[whichParty * 6 + 1][0]) / 2 * 8 + 14;
        gSprites[gUnknown_0203229C->partyIcons[0][partyIdx + (whichParty * 6)]].pos1.y = (gTradeMonSpriteCoords[whichParty * 6][1] * 8) - 12;
        gSprites[gUnknown_0203229C->partyIcons[0][partyIdx + (whichParty * 6)]].pos2.x = 0;
        gSprites[gUnknown_0203229C->partyIcons[0][partyIdx + (whichParty * 6)]].pos2.y = 0;
...
static void sub_8079AA4(u8 *a0, u8 a1, u8 a2)
{
    ...
    if (!gUnknown_0203229C->unk_51[a1][a2])
    {
        for (i = 0; i < 4; i++)
        {
            if (!a1)
            {
                arr[i] = GetMonData(&gPlayerParty[a2], i + 13, ((void *)0));
            }
            else
            {
                arr[i] = GetMonData(&gEnemyParty[a2], i + 13, ((void *)0));
            }
        }
...
static void sub_8079C4C(u8 whichParty, u8 monIdx, u8 a2, u8 a3, u8 a4, u8 a5)
{
    ...
    else
    {
        ...
        {
            case 0x00:
                r2 = !NameHasGenderSymbol(nickname, 0x00) ? 0x84 : 0x83;
                break;
            case 0xFE:
                r2 = !NameHasGenderSymbol(nickname, 0xFE) ? 0x85 : 0x83;
                break;
            default:
                r2 = 0x83;
                break;
...
static void sub_8079EA8(u8 whichParty)
{
    ...
    for (i = 0; i < gUnknown_0203229C->partyCounts[whichParty]; i++)
    {
        gSprites[gUnknown_0203229C->partyIcons[whichParty][i]].invisible = 0;
        gSprites[gUnknown_0203229C->partyIcons[whichParty][i]].pos1.x = gTradeMonSpriteCoords[(whichParty * 6) + i][0] * 8 + 14;
        gSprites[gUnknown_0203229C->partyIcons[whichParty][i]].pos1.y = gTradeMonSpriteCoords[(whichParty * 6) + i][1] * 8 - 12;
...
static void sub_807A048(u16 a0, u8 a1)
{
    ...
    for (i = 0; i < 4; i++)
    {
        if (!gUnknown_0203229C->unk_8D0[i].unk_0)
        {
            ...
            gUnknown_0203229C->unk_8D0[i].unk_0 = 1;
            break;
        }
    }
}
...
static void sub_807A19C(u8 a0)
{
    ...
    AddTextPrinterParameterized(0, 1, gUnknown_0832DEBC[a0], 0, 1, 0xFF, ((void *)0));
...
static u32 sub_807A5F4(struct Pokemon *monList, int a1, int monIdx)
{
    ...
    for (i = 0; i < a1; i++)
    {
        species2[i] = GetMonData(&monList[i], 65);
        species[i] = GetMonData(&monList[i], 11);
    }
    ...
    {
        if (!GetMonData(&monList[monIdx], 80))
        {
            return 4;
        }
    }
...
int sub_807A7E0(struct UnkLinkRfuStruct_02022B14Substruct a0, struct UnkLinkRfuStruct_02022B14Substruct a1, u16 species1, u16 species2, u8 type, u16 species3, u8 isObedientBitSet)
{
    ...
    if (species1 == 412 && species1 != species2)
    {
        return 3;
    }
...
static void sub_807ABCC(void)
{
    ...
    SetGpuReg(0x16, gUnknown_020322A0->bg1vofs);
    SetGpuReg(0x14, gUnknown_020322A0->bg1hofs);

    dispcnt = GetGpuReg(0x0);
    if ((dispcnt & 7) == 0x0000)
    {
        SetGpuReg(0x1a, gUnknown_020322A0->bg2vofs);
        SetGpuReg(0x18, gUnknown_020322A0->bg2hofs);
    }
    else
    {
        sub_807AB28();
...
static void sub_807ACFC(u8 whichParty, u8 a1)
{
    ...
    if (whichParty == 1)
    {
        mon = &gEnemyParty[gUnknown_02032298[1] % 6];
        pos = 3;
    }
    ...
    switch (a1)
    {
        ...
        case 1:
            ...
            gSprites[gUnknown_020322A0->pokePicSpriteIdxs[whichParty]].invisible = 1;
...
void sub_807AE50(void)
{
    switch (gMain.state)
    {
        case 0:
            ...
            gUnknown_020322A0->isLinkTrade = 1;
...
static void sub_807B170(void)
{
    SetGpuReg(0x0, 0);
    ResetBgsAndClearDma3BusyFlags(0);
    InitBgsFromTemplates(0, gUnknown_08339014, (size_t)(sizeof(gUnknown_08339014) / sizeof((gUnknown_08339014)[0])));
    ChangeBgX(0, 0, 0);
    ChangeBgY(0, 0, 0);
...
static void sub_807B270(void)
{
    ...
    switch (gMain.state)
    {
        case 0:
            ...
            SetVBlankCallback(sub_807AC24);
            sub_807B170();
            gUnknown_020322A0->isLinkTrade = 0;
            gUnknown_020322A0->unk_8C = 0;
            gUnknown_020322A0->state = 0;
            gUnknown_020322A0->unk_D4 = 64;
            gUnknown_020322A0->unk_D6 = 64;
...
static void sub_807B5B8(void)
{
    switch (gUnknown_020322A0->unk_93)
    {
        case 1:
            ...
            {
                (SendBlock(bitmask_all_link_players_but_self(), gUnknown_020322A0->linkData, 20));
...
static void sub_807B62C(u8 a0)
{
    switch (a0)
    {
        ...
        case 1:
            ...
            {
                { const void *_src = gUnknown_083369A0; void *_dest = (void *) (0x6000000 + (0x800 * (5))); u32 _size = 0x1000; { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)(_src); dmaRegs[1] = (vu32)(_dest); dmaRegs[2] = (vu32)((0x8000 | 0x0000 | 0x0000 | 0x0000 | 0x0000) << 16 | ((_size)/(16/8))); dmaRegs[2]; }; };
            }
            else
            {
                { const void *_src = gUnknown_083359A0; void *_dest = (void *) (0x6000000 + (0x800 * (5))); u32 _size = 0x1000; { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)(_src); dmaRegs[1] = (vu32)(_dest); dmaRegs[2] = (vu32)((0x8000 | 0x0000 | 0x0000 | 0x0000 | 0x0000) << 16 | ((_size)/(16/8))); dmaRegs[2]; }; };
            }
        ...
        case 2:
            ...
            else
            {
                SetGpuReg(0x0, 0x0001 |
                                              ...
                                              0x0200 |
                                              0x1000);
                { const void *_src = gUnknown_0832FFC0; void *_dest = (void *) (0x6000000 + (0x800 * (5))); u32 _size = 0x800; { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)(_src); dmaRegs[1] = (vu32)(_dest); dmaRegs[2] = (vu32)((0x8000 | 0x0000 | 0x0000 | 0x0000 | 0x0000) << 16 | ((_size)/(16/8))); dmaRegs[2]; }; };
                BlendPalettes(0x1, 16, ((0) | ((0) << 5) | ((0) << 10)));
            }
            break;
        case 3:
            LoadPalette(gUnknown_08337EA0, 48, 0x20);
            LZ77UnCompVram(gUnknown_08337EC0, (void *) (0x6000000 + (0x4000 * (1))));
            LZ77UnCompVram(gUnknown_08338550, (void *) (0x6000000 + (0x800 * (18))));
        ...
        case 4:
            ...
            { const void *_src = gUnknown_08332F60; void *_dest = (void *) (0x6000000 + (0x4000 * (1))); u32 _size = 0x2840; while (1) { { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)(_src); dmaRegs[1] = (vu32)(_dest); dmaRegs[2] = (vu32)((0x8000 | 0x0000 | 0x0000 | 0x0000 | 0x0000) << 16 | (((0x1000))/(16/8))); dmaRegs[2]; }; _src += (0x1000); _dest += (0x1000); _size -= (0x1000); if (_size <= (0x1000)) { { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)(_src); dmaRegs[1] = (vu32)(_dest); dmaRegs[2] = (vu32)((0x8000 | 0x0000 | 0x0000 | 0x0000 | 0x0000) << 16 | ((_size)/(16/8))); dmaRegs[2]; }; break; } } };

            if (gUnknown_020322A0->unk_FA)
            {
                { const void *_src = gUnknown_083357A0; void *_dest = (void *) (0x6000000 + (0x800 * (18))); u32 _size = 0x100; { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)(_src); dmaRegs[1] = (vu32)(_dest); dmaRegs[2] = (vu32)((0x8000 | 0x0000 | 0x0000 | 0x0000 | 0x0000) << 16 | ((_size)/(16/8))); dmaRegs[2]; }; };
            }
            else
            {
                { const void *_src = gUnknown_083358A0; void *_dest = (void *) (0x6000000 + (0x800 * (18))); u32 _size = 0x100; { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)(_src); dmaRegs[1] = (vu32)(_dest); dmaRegs[2] = (vu32)((0x8000 | 0x0000 | 0x0000 | 0x0000 | 0x0000) << 16 | ((_size)/(16/8))); dmaRegs[2]; }; };
            }
            break;
        case 5:
            gUnknown_020322A0->bg1vofs = 0;
...
static void SetTradeSceneStrings(void)
{
    ...
    if (gUnknown_020322A0->isLinkTrade)
    {
        ...
        GetMonData(&gEnemyParty[gUnknown_02032298[1] % 6], 2, name);
        StringCopy10(gStringVar3, name);
        GetMonData(&gPlayerParty[gUnknown_02032298[0]], 2, name);
...
static bool8 sub_807BBEC(void)
{
    ...
    {
        case 0:
            gSprites[gUnknown_020322A0->pokePicSpriteIdxs[0]].invisible = 0;
        ...
        case 10:
            ...
            if (gUnknown_020322A0->tradeSpecies[0] != 412)
            {
        ...
        case 37:
            ...
            gSprites[gUnknown_020322A0->pokePicSpriteIdxs[0]].invisible = 0;
            gSprites[gUnknown_020322A0->pokePicSpriteIdxs[1]].invisible = 0;
            gUnknown_020322A0->state++;
            break;
        case 38:
            ...
            if (gSprites[gUnknown_020322A0->pokePicSpriteIdxs[0]].pos2.y < -222)
            {
                ...
                gUnknown_020322A0->state++;
                gSprites[gUnknown_020322A0->pokePicSpriteIdxs[0]].invisible = 1;
                gSprites[gUnknown_020322A0->pokePicSpriteIdxs[1]].invisible = 1;
                BlendPalettes(0x1, 0, (((31) | ((31) << 5) | ((31) << 10)) | 0x8000));
            }
            break;
        case 39:
        ...
        case 63:
            ...
            BlendPalettes(1 << (16 + gSprites[gUnknown_020322A0->unk_D3].oam.paletteNum), 16, (((31) | ((31) << 5) | ((31) << 10)) | 0x8000));
            gUnknown_020322A0->state++;
            gUnknown_020322A0->timer = 0;
            break;
        case 64:
            BeginNormalPaletteFade(1 << (16 + gSprites[gUnknown_020322A0->unk_D3].oam.paletteNum), 1, 16, 0, (((31) | ((31) << 5) | ((31) << 10)) | 0x8000));
            gUnknown_020322A0->state++;
            break;
        case 65:
        ...
        case 72:
            ...
            evoTarget = GetEvolutionTargetSpecies(&gPlayerParty[gUnknown_02032298[0]], 1, 0);
            if (evoTarget != 0)
            {
        ...
        case 74:
            if (!gPaletteFade.active)
            {
                ...
                if (gUnknown_020322A0)
                {
                    ...
                    FreeMonSpritesGfx();
                    { Free(gUnknown_020322A0); gUnknown_020322A0 = ((void *)0); };
                }
...
static void sub_807F14C(void)
{
    ...
    for (i = 0; i < 12; i ++)
    {
        numRibbons += GetMonData(&gEnemyParty[gUnknown_02032298[1] % 6], 67 + i);
    }
    if (numRibbons != 0)
...
static void c3_0805465C(u8 taskId)
{
    ...
    SetGpuReg(0x40, ((gUnknown_020322A0->unk_FD) | ((gUnknown_020322A0->unk_FB) << 8)));
    SetGpuReg(0x44, ((gUnknown_020322A0->unk_FE) | ((gUnknown_020322A0->unk_FC) << 8)));
