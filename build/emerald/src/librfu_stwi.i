...
void STWI_init_all(struct RfuIntrStruct *interruptStruct, IntrFunc *interrupt, bool8 copyInterruptToRam)
{
    ...
    if (copyInterruptToRam == 1)
    {
        *interrupt = (IntrFunc)interruptStruct->block1;
        { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)(&IntrSIO32); dmaRegs[1] = (vu32)(interruptStruct->block1); dmaRegs[2] = (vu32)((0x8000 | 0x0000 | 0x0000 | 0x0000 | 0x0000) << 16 | ((0x960)/(16/8))); dmaRegs[2]; };
...
void STWI_init_timer(IntrFunc *interrupt, int timerSelect)
{
    *interrupt = STWI_intr_timer;
    ...
    { u16 imeTemp; imeTemp = (*(vu16 *)(0x4000000 + 0x208)); (*(vu16 *)(0x4000000 + 0x208)) = 0; (*(vu16 *)(0x4000000 + 0x200)) |= (1 << 3) << gRfuState->timerSelect; (*(vu16 *)(0x4000000 + 0x208)) = imeTemp; };
}
...
void AgbRFU_SoftReset(void)
{
    ...
    timerL = &(*(vu16 *)((0x4000000 + 0x100) + ((gRfuState->timerSelect) * 4)));
    timerH = &(*(vu16 *)((0x4000000 + 0x102) + ((gRfuState->timerSelect) * 4)));
    *timerH = 0;
    *timerL = 0;
    *timerH = 0x83;
    while (*timerL <= 0x11)
...
void STWI_send_DataTxREQ(void *in, u8 size)
{
    if (!STWI_init(RFU_DATA_TX))
    {
        ...
        CpuSet(in, gRfuState->txPacket->rfuPacket32.data, 0x04000000 | ((gRfuState->txParams * sizeof(u32))/(32/8) & 0x1FFFFF));
        STWI_start_Command();
    }
}
...
void STWI_set_timer(u8 unk)
{
    ...
    *timerH = 0x80 | 0x40 | 0x03;
    (*(vu16 *)(0x4000000 + 0x202)) = (1 << 3) << gRfuState->timerSelect;
...
void STWI_stop_timer(void)
{
    ...
    (*(vu16 *)((0x4000000 + 0x100) + ((gRfuState->timerSelect) * 4))) = 0;
    (*(vu16 *)((0x4000000 + 0x102) + ((gRfuState->timerSelect) * 4))) = 0;
}
...
int STWI_start_Command()
{
    ...
    *(u32*)gRfuState->txPacket->rfuPacket8.data = 0x99660000 | (gRfuState->txParams << 8) | gRfuState->activeCommand;
    (*(vu32 *)(0x4000000 + 0x120)) = gRfuState->txPacket->rfuPacket32.command;
    ...
    (*(vu16 *)(0x4000000 + 0x208)) = 0;
    (*(vu16 *)(0x4000000 + 0x200)) |= ((1 << 3) << gRfuState->timerSelect);
