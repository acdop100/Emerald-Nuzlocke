...
# 1 "include/constants/bg_event_constants.h" 1
# 37 "src/secret_base.c" 2
...
void InitSecretBaseDecorationSprites(void)
{
    ...
    for (i = 0; i < numDecorations; i++)
    {
        ...
        if (permission == DECORPERM_SPRITE)
        {
            ...
            {
                if (gMapHeader.events->eventObjects[eventObjectId].flagId == 0xAE + gSpecialVar_0x8004)
                    break;
            }
            ...
            {
                gSpecialVar_Result = 0x4010 + (gMapHeader.events->eventObjects[eventObjectId].graphicsId - 240);
...
void GetSecretBaseOwnerInteractionState(void)
{
    ...
    secretBaseId = VarGet(0x4054);
    if (!FlagGet(((0x500 + 0x356 + 0xA) + 0xC2)))
    {
        for (i = 0; i < 20; i++)
            gSaveBlock1Ptr->secretBases[i].battledOwnerToday = 0;

        FlagSet(((0x500 + 0x356 + 0xA) + 0xC2));
    }
    ...
    case 1:
        ...
        if (x != data[2] || y != data[3])
        {
            ...
            if (tileId == 0x234 || tileId == 0x23C)
            {
                ...
                {
                    VarSet(0x40EF, VarGet(0x40EF) | 0x20);
                }
            }
            ...
            {
                if (sInFriendSecretBase == 1)
                    VarSet(0x40EF, VarGet(0x40EF) | 0x80);
            }
            else if (MetatileBehavior_IsSecretBaseBalloon(behavior) == 1)
            {
                ...
                if (sInFriendSecretBase == 1)
                {
                    ...
                    case 0x33c:
                    case 0x340:
                        VarSet(0x40EE, VarGet(0x40EE) | 0x02);
                        break;
                    case 0x228:
                        VarSet(0x40EE, VarGet(0x40EE) | 0x100);
                        break;
                    }
                }
            }
...
{
    if (VarGet(0x4054) != 0)
        VarSet(0x40EF, VarGet(0x40EF) | 0x800);
}

void sub_80EB2C8(void)
{
    if (VarGet(0x4054) != 0)
        VarSet(0x40EE, VarGet(0x40EE) | 0x400);
}
...
void sub_80EB300(void)
{
    if (VarGet(0x4054) != 0)
    {
        VarSet(0x40EE, VarGet(0x40EE) & ~0x3800);
        VarSet(0x40EF, VarGet(0x40EF) & ~0x001);
        VarSet(0x40EE, VarGet(0x40EE) | 0x2000);
    }
}
...
void sub_80EB368(void)
{
    if (VarGet(0x4054) != 0)
    {
        VarSet(0x40EE, VarGet(0x40EE) & ~0x3800);
        VarSet(0x40EF, VarGet(0x40EF) & ~0x001);
        VarSet(0x40EE, VarGet(0x40EE) | 0x800);
    }
}
...
void sub_80EB3D0(void)
{
    if (VarGet(0x4054) != 0)
    {
        VarSet(0x40EE, VarGet(0x40EE) & ~0x3800);
        VarSet(0x40EF, VarGet(0x40EF) & ~0x001);
        VarSet(0x40EE, VarGet(0x40EE) | 0x1000);
    }
}
...
void SetSecretBaseSecretsTvFlags_Poster(void)
{
    ...
    switch (MapGridGetMetatileIdAt(x, y))
    {
        ...
        case 0x334:
            if (VarGet(0x4054) != 0)
                VarSet(0x40EE, VarGet(0x40EE) | 0x4000);
            break;
    }
}
...
void SetSecretBaseSecretsTvFlags_MiscFurnature(void)
{
    ...
    switch (MapGridGetMetatileIdAt(x, y))
    {
        ...
        case 0x28b:
            ...
            if (VarGet(0x4054) != 0)
                VarSet(0x40EE, VarGet(0x40EE) | 0x40);
            break;
        case 0x2d8:
        case 0x2d9:
        case 0x2da:
        ...
        case 0x2fb:
            ...
            if (VarGet(0x4054) != 0)
                VarSet(0x40EE, VarGet(0x40EE) | 0x8);
            break;
        case 0x22c:
        case 0x233:

            if (VarGet(0x4054) != 0)
                VarSet(0x40EF, VarGet(0x40EF) | 0x40);
            break;
        case 0x288:
        case 0x289:

            if (VarGet(0x4054) != 0)
                VarSet(0x40EF, VarGet(0x40EF) | 0x100);
            break;
        case 0x22d:
        case 0x22e:
        case 0x22f:
            ...
            if (VarGet(0x4054) != 0)
                VarSet(0x40EF, VarGet(0x40EF) | 0x10);
            break;
        case 0x287:
        case 0x28f:
        case 0x298:
        ...
        case 0x2cf:
            ...
            if (VarGet(0x4054) != 0)
                VarSet(0x40EF, VarGet(0x40EF) | 0x8);
            break;
    }
}
...
void SetSecretBaseSecretsTvFlags_SandOrnament(void)
{
    ...
    switch ((int)MapGridGetMetatileIdAt(x, y))
    {
        ...
        case 0x28e:
            ...
            if (VarGet(0x4054) != 0)
                VarSet(0x40EF, VarGet(0x40EF) | 0x4);
            break;
    }
}
