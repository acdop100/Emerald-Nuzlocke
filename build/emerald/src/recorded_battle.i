...
bool32 MoveRecordedBattleToSaveData(void)
{
    ...
    if (gTrainerBattleOpponent_A >= 400)
    {
        ...
        for (i = 0; i < 6; i++)
            battleSave->easyChatSpeech[i] = gSaveBlock2Ptr->apprentices[gTrainerBattleOpponent_A - 400].easyChatWords[i];
    ...
    else if (gTrainerBattleOpponent_B >= 400)
    {
        ...
        for (i = 0; i < 6; i++)
            battleSave->easyChatSpeech[i] = gSaveBlock2Ptr->apprentices[gTrainerBattleOpponent_B - 400].easyChatWords[i];
