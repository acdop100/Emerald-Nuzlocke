...
# 1 "include/sprite.h" 1
# 18 "src/battle_anim_effects_3.c" 2
# 1 "include/task.h" 1
...
void sub_815B338(u8 taskId)
{
    ...
    {
    case 0:
        PrepareAffineAnimInTaskData(&gTasks[taskId], GetAnimBattlerSpriteId(0), gUnknown_085CE350);
...
void sub_815B65C(u8 taskId)
{
    ...
    {
        PrepareAffineAnimInTaskData(&gTasks[taskId], GetAnimBattlerSpriteId(0), gUnknown_085CE3B8);
        gTasks[taskId].data[0]++;
    }
    else
    {
...
void sub_815B6B4(u8 taskId)
{
    if (!gTasks[taskId].data[0])
    {
        PrepareAffineAnimInTaskData(&gTasks[taskId], GetAnimBattlerSpriteId(0), gUnknown_085CE3E0);
        gTasks[taskId].data[0]++;
    }
    else
    {
...
void sub_815B778(u8 taskId)
{
    if (!gTasks[taskId].data[0])
    {
        PrepareAffineAnimInTaskData(&gTasks[taskId], GetAnimBattlerSpriteId(0), gUnknown_085CE430);
        gTasks[taskId].data[0]++;
    }
    else
    {
