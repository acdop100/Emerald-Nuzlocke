...
# 1 "include/text.h" 1
# 35 "src/contest_link_80F57C4.c" 2
# 1 "include/trig.h" 1
...
# 1 "include/window.h" 1
# 39 "src/contest_link_80F57C4.c" 2
# 1 "include/constants/game_stat.h" 1
...
void sub_80F57C4(void)
{
    ...
    InitBgsFromTemplates(0, gUnknown_0858D888, (size_t)(sizeof(gUnknown_0858D888) / sizeof((gUnknown_0858D888)[0])));
    for (i = 0; i < 4; i++)
    ...
    case 0:
        ...
        if (ribbonData <= gSpecialVar_ContestRank && ribbonData < 4)
        {
            ...
            if (GetRibbonCount(&gPlayerParty[gContestMonPartyIndex]) > 4)
                sub_80EE4DC(&gPlayerParty[gContestMonPartyIndex], 50);
        }
        break;
    case 1:
        ...
        if (ribbonData <= gSpecialVar_ContestRank && ribbonData < 4)
        {
            ...
            if (GetRibbonCount(&gPlayerParty[gContestMonPartyIndex]) > 4)
                sub_80EE4DC(&gPlayerParty[gContestMonPartyIndex], 51);
        }
        break;
    case 2:
        ...
        if (ribbonData <= gSpecialVar_ContestRank && ribbonData < 4)
        {
            ...
            if (GetRibbonCount(&gPlayerParty[gContestMonPartyIndex]) > 4)
                sub_80EE4DC(&gPlayerParty[gContestMonPartyIndex], 52);
        }
        break;
    case 3:
        ...
        if (ribbonData <= gSpecialVar_ContestRank && ribbonData < 4)
        {
            ...
            if (GetRibbonCount(&gPlayerParty[gContestMonPartyIndex]) > 4)
                sub_80EE4DC(&gPlayerParty[gContestMonPartyIndex], 53);
        }
        break;
    case 4:
        ...
        if (ribbonData <= gSpecialVar_ContestRank && ribbonData < 4)
        {
            ...
            if (GetRibbonCount(&gPlayerParty[gContestMonPartyIndex]) > 4)
                sub_80EE4DC(&gPlayerParty[gContestMonPartyIndex], 54);
        }
        break;
    }
}
