...
{
    sub_8122CF8(regionMap, ((void *)0), zoomed);
    while (sub_8122DB0());
}
...
bool8 sub_8122DB0(void)
{
    ...
    case 0:
        ...
        {
            LZ77UnCompVram(sRegionMapBkgnd_GfxLZ, (u16 *)(0x6000000 + (0x4000 * (2))));
        }
        break;
    case 1:
        if (gRegionMap->bgManaged)
        ...
        {
            LZ77UnCompVram(sRegionMapBkgnd_TilemapLZ, (u16 *)(0x6000000 + (0x800 * (28))));
        }
        break;
    case 2:
        if (!free_temp_tile_data_buffers_if_possible())
...
static u8 get_flagnr_blue_points(u16 mapSecId)
{
    switch (mapSecId)
    {
        ...
        case 0x00:
            return FlagGet(((0x500 + 0x356 + 0xA) + 0xF)) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
        case 0x01:
            return FlagGet(((0x500 + 0x356 + 0xA) + 0x10)) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
        case 0x02:
            return FlagGet(((0x500 + 0x356 + 0xA) + 0x11)) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
        case 0x03:
            return FlagGet(((0x500 + 0x356 + 0xA) + 0x12)) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
        case 0x04:
            return FlagGet(((0x500 + 0x356 + 0xA) + 0x13)) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
        case 0x05:
            return FlagGet(((0x500 + 0x356 + 0xA) + 0x14)) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
        case 0x06:
            return FlagGet(((0x500 + 0x356 + 0xA) + 0x15)) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
        case 0x07:
            return FlagGet(((0x500 + 0x356 + 0xA) + 0x16)) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
        case 0x08:
            return FlagGet(((0x500 + 0x356 + 0xA) + 0x17)) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
        case 0x09:
            return FlagGet(((0x500 + 0x356 + 0xA) + 0x18)) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
        case 0x0A:
            return FlagGet(((0x500 + 0x356 + 0xA) + 0x19)) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
        case 0x0B:
            return FlagGet(((0x500 + 0x356 + 0xA) + 0x1A)) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
        case 0x0C:
            return FlagGet(((0x500 + 0x356 + 0xA) + 0x1B)) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
        case 0x0D:
            return FlagGet(((0x500 + 0x356 + 0xA) + 0x1C)) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
        case 0x0E:
            return FlagGet(((0x500 + 0x356 + 0xA) + 0x1D)) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
        case 0x0F:
            return FlagGet(((0x500 + 0x356 + 0xA) + 0x1E)) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
        case 0x3A:
            return FlagGet(((0x500 + 0x356 + 0xA) + 0x48)) ? MAPSECTYPE_BATTLE_FRONTIER : MAPSECTYPE_NONE;
        case 0x49:
            return FlagGet(((0x500 + 0x356 + 0xA) + 0x49)) ? MAPSECTYPE_PLAIN : MAPSECTYPE_NONE;
        default:
...
static void RegionMap_GetMarineCaveCoords(u16 *x, u16 *y)
{
    ...
    idx -= 9;
    *x = sTerraCaveLocationCoords[idx].x + 1;
    *y = sTerraCaveLocationCoords[idx].y + 2;
}
...
void MCB2_FlyMap(void)
{
    switch (gMain.state)
    {
        ...
        case 4:
            ...
            StringFill(sFlyMap->unk_a4c, 0x00, 16);
            gUnknown_03001180 = 1;
            sub_8124904();
            gMain.state++;
            break;
...
static void sub_8124904(void)
{
    ...
    {
        flag = 0;
        for (i = 0; i < (size_t)(sizeof(gUnknown_085A1EDC) / sizeof((gUnknown_085A1EDC)[0])); i++)
        {
            if (sFlyMap->regionMap.mapSecId == gUnknown_085A1EDC[i].mapSecId)
            {
                if (FlagGet(gUnknown_085A1EDC[i].flag))
                {
                    ...
                    DrawStdFrameWithCustomTileAndPalette(1, 0, 0x65, 0x0d);
                    ...
                    AddTextPrinterParameterized(1, 1, name, GetStringRightAlignXOffset(1, name, 0x60), 0x11, 0, ((void *)0));
                    schedule_bg_copy_tilemap_to_vram(0);
                    gUnknown_03001180 = 1;
                }
                break;
        ...
        if (!flag)
        {
            if (gUnknown_03001180 == 1)
            {
                ...
                DrawStdFrameWithCustomTileAndPalette(0, 0, 0x65, 0x0d);
            }
            else
            {
...
static void sub_8124AD4(void)
{
    ...
    canFlyFlag = ((0x500 + 0x356 + 0xA) + 0xF);
    for (i = 0; i < 16; i++)
    {
...
static void sub_8124BE4(void)
{
    ...
    for (i = 0; sUnknown_085A1F18[i][1] != 0xD5; i++)
    {
                ...
                if (sFlyMap->unk_a72)
                {
                    switch (sFlyMap->regionMap.mapSecId)
                    {
                        ...
                        case 0x00:
                            ...
                            break;
                        case 0x0F:
                            SetWarpDestinationToHealLocation(FlagGet(((0x500 + 0x356 + 0xA) + 0x54)) && sFlyMap->regionMap.posWithinMapSec == 0 ? 20 : 11);
                            break;
                        default:
