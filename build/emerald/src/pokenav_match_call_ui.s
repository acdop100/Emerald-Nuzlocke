...
sub_81C8630:
	...
	bx	r1
.Lfe16:
	.size	 sub_81C8630,.Lfe16-sub_81C8630
	.align	2, 0
...
.Lfe21:
	...
	.align	2, 0
	.globl	GetSelectedMatchCall
	.type	 GetSelectedMatchCall,function
	.thumb_func
GetSelectedMatchCall:
	push	{lr}
	bl	GetMatchCallWindowStruct
	add	r1, r0, #0
	ldrh	r0, [r1]
	...
	bx	r1
.Lfe22:
	.size	 GetSelectedMatchCall,.Lfe22-GetSelectedMatchCall
	.align	2, 0
...
.L132:
	.word	0x888
	.word	0x89c
	.word	LoopedTask_sub_81C8958
.Lfe25:
	.size	 sub_81C87AC,.Lfe25-sub_81C87AC
	.align	2, 0
	.globl	sub_81C87F0
...
sub_81C8820:
	...
	bx	r1
.Lfe27:
	.size	 sub_81C8820,.Lfe27-sub_81C8820
	.align	2, 0
	.globl	sub_81C8838
...
.Lfe29:
	...
	.align	2, 0
	.globl	LoopedTask_sub_81C8958
	.type	 LoopedTask_sub_81C8958,function
	.thumb_func
LoopedTask_sub_81C8958:
	push	{r4, r5, lr}
	add	r5, r0, #0
	mov	r0, #0x11
	bl	GetSubstructPtr
...
.L186:
	...
	bx	r1
.Lfe30:
	.size	 LoopedTask_sub_81C8958,.Lfe30-LoopedTask_sub_81C8958
	.align	2, 0
...
.L262:
	.word	array.111
.Lfe37:
	.size	 sub_81C8E54,.Lfe37-sub_81C8E54
	.section .rodata
	.align	2, 0
...
.Lfe39:
	.size	 sub_81C8EF8,.Lfe39-sub_81C8EF8
	.align	2, 0
	.globl	sub_81C8FE0
	.type	 sub_81C8FE0,function
	.thumb_func
sub_81C8FE0:
	push	{r4, lr}
	add	r4, r0, #0
	...
	bx	r0
.Lfe40:
	.size	 sub_81C8FE0,.Lfe40-sub_81C8FE0
	.align	2, 0
...
.L299:
	...
	bx	r0
.Lfe46:
	.size	 sub_81C9160,.Lfe46-sub_81C9160
	.align	2, 0
	.globl	sub_81C91AC
	.type	 sub_81C91AC,function
	.thumb_func
sub_81C91AC:
	push	{r4, r5, r6, r7, lr}
	mov	r7, r9
...
.L304:
	...
	bx	r1
.Lfe47:
	.size	 sub_81C91AC,.Lfe47-sub_81C91AC
.text
	.align	2, 0
