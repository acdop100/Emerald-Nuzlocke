...
static const u16 gUnknown_0860DE78[] = {63, 64, 65, 67, 66, 70};
static const u16 gUnknown_0860DE84[] = {179, 180, 183, 200, 185, 187, 196, 198, 186};
...
static void sub_8195D28(void)
{
    ...
    if (gSaveBlock2Ptr->frontier.palaceWinStreaks[battleMode][lvlMode] > 41)
        gSaveBlock2Ptr->frontier.field_DC6 = gUnknown_0860DE84[Random() % (size_t)(sizeof(gUnknown_0860DE84) / sizeof((gUnknown_0860DE84)[0]))];
    else
        gSaveBlock2Ptr->frontier.field_DC6 = gUnknown_0860DE78[Random() % (size_t)(sizeof(gUnknown_0860DE78) / sizeof((gUnknown_0860DE78)[0]))];
}

static void sub_8195DB8(void)
{
    if (AddBagItem(gSaveBlock2Ptr->frontier.field_DC6, 1) == 1)
    {
