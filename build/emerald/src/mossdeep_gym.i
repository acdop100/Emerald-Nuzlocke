...
# 5 "src/mossdeep_gym.c" 2
# 1 "include/mossdeep_gym.h" 1
...
{
    struct MossdeepSubStruct objects[16];
    u8 count;
    bool8 unk41;
};
...
__attribute__((section("ewram_data"))) static struct MossdeepStruct *gUnknown_0203CE50 = ((void *)0);


void InitMossdeepGymTiles(bool8 arg0)
{
    if (gUnknown_0203CE50 == ((void *)0))
...
void FinishMossdeepGymTiles(void)
{
    ...
    if (gUnknown_0203CE50 != ((void *)0))
        { Free(gUnknown_0203CE50); gUnknown_0203CE50 = ((void *)0); };
...
u16 MossdeepGym_MoveEvents(u8 arg0)
{
    ...
    for (i = 0; i < 64; i++)
    {
        ...
        if (r5 < 4)
        {
            ...
            events[i].x += x;
            events[i].y += y;
            if (GetEventObjectIdByLocalIdAndMap(events[i].localId, gSaveBlock1Ptr->location.mapNum, gSaveBlock1Ptr->location.mapGroup) != 16)
            {
                AddEventObject(i, r5);
        ...
        if (eventObjectId != 16)
        {
            ...
            if (r6 == 0)
            {
                ...
                case 4:
                    ...
                    events[gUnknown_0203CE50->objects[i].eventTemplateId].movementType = 0x7;
                    break;
                case 1:
                    movementScript = gUnknown_086126A8;
                    events[gUnknown_0203CE50->objects[i].eventTemplateId].movementType = 0xA;
                    break;
                case 3:
                    movementScript = gUnknown_086126AA;
                    events[gUnknown_0203CE50->objects[i].eventTemplateId].movementType = 0x8;
                    break;
                case 2:
                    movementScript = gUnknown_086126AC;
                    events[gUnknown_0203CE50->objects[i].eventTemplateId].movementType = 0x9;
                    break;
                default:
                    continue;
                }
...
static void sub_81A8D94(u8 eventTemplateId, u8 arg1)
{
    ...
    if (r6 == 0)
    {
        ...
        {
        case 0xA:
            events[eventTemplateId].movementType = 0x7;
            break;
        case 0x8:
            events[eventTemplateId].movementType = 0xA;
            break;
        case 0x9:
            events[eventTemplateId].movementType = 0x8;
            break;
        case 0x7:
            events[eventTemplateId].movementType = 0x9;
            break;
        default:
            break;
        }
