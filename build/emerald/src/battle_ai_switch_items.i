...
static bool8 FindMonThatAbsorbsOpponentsMove(void)
{
    ...
    if (gBattleMoves[gLastLandedMoves[gActiveBattler]].type == 0x0a)
        absorbingTypeAbility = 18;
    else if (gBattleMoves[gLastLandedMoves[gActiveBattler]].type == 0x0b)
        absorbingTypeAbility = 11;
    else if (gBattleMoves[gLastLandedMoves[gActiveBattler]].type == 0x0d)
...
static bool8 ShouldSwitch(void)
{
    ...
    {
        if (gBattleMons[gActiveBattler].type1 == 0x08)
            return 0;
        if (gBattleMons[gActiveBattler].type2 == 0x08)
            return 0;
    }
