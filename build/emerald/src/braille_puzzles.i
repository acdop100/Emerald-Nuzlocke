...
{
    if (!FlagGet(((0x500 + 0x356 + 0xA) + 0x4F))
...
{
    if (!FlagGet(((0x500 + 0x356 + 0xA) + 0x50))
...
void DoBrailleRegirockEffect(void)
{
    ...
    DrawWholeMapView();
    PlaySE(20);
    FlagSet(((0x500 + 0x356 + 0xA) + 0x50));
    ScriptContext2_Disable();
}

bool8 ShouldDoBrailleRegisteelEffect(void)
{
    if (!FlagGet(((0x500 + 0x356 + 0xA) + 0x52)) && (gSaveBlock1Ptr->location.mapGroup == ((68 | (24 << 8)) >> 8) && gSaveBlock1Ptr->location.mapNum == ((68 | (24 << 8)) & 0xFF)))
    {
...
bool8 ShouldDoBrailleRegicePuzzle(void)
{
    ...
    {
        if (FlagGet(((0x500 + 0x356 + 0xA) + 0x51)))
            return 0;
        if (FlagGet(0x2) == 0)
            return 0;
        if (FlagGet(0x3) == 1)
