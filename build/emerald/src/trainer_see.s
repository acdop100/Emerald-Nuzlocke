...
.Lfe33:
	...
	.align	2, 0
	.globl	GetCurrentApproachingTrainerEventObjectId
	.type	 GetCurrentApproachingTrainerEventObjectId,function
	.thumb_func
...
.L211:
	.word	gApproachingTrainers
.Lfe34:
	.size	 GetCurrentApproachingTrainerEventObjectId,.Lfe34-GetCurrentApproachingTrainerEventObjectId
	.align	2, 0
	.globl	GetChosenApproachingTrainerEventObjectId
	.type	 GetChosenApproachingTrainerEventObjectId,function
	.thumb_func
GetChosenApproachingTrainerEventObjectId:
	push	{lr}
	lsl	r0, r0, #0x18
	lsr	r0, r0, #0x18
	cmp	r0, #0x1
...
.L222:
	.word	gApproachingTrainers
.Lfe35:
	.size	 GetChosenApproachingTrainerEventObjectId,.Lfe35-GetChosenApproachingTrainerEventObjectId
	.align	2, 0
	.globl	sub_80B4808
	.type	 sub_80B4808,function
	.thumb_func
sub_80B4808:
	push	{lr}
	ldr	r0, .L227
...
.L227:
	.word	gUnknown_030060AC
	.word	gApproachingTrainers
	.word	gUnknown_03006080
	.word	gEventObjects
	.word	gUnknown_03006084
	.word	gSaveBlock1Ptr
.L225:
	ldr	r0, .L229
	ldrb	r1, [r0, #0x5]
...
.L229:
	...
	.word	gSaveBlock1Ptr
.Lfe36:
	.size	 sub_80B4808,.Lfe36-sub_80B4808
	.comm	gUnknown_03006080, 4	@ 2
	.comm	gUnknown_03006084, 4	@ 4
	.comm	gApproachingTrainers, 24	@ 24
	.comm	gNoOfApproachingTrainers, 4	@ 1
	.comm	gUnknown_030060AC, 4	@ 1
.text
	.align	2, 0
