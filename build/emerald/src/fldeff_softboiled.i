...
void sub_81615A8(u8 taskId)
{
    ...
    hp = GetMonData(&gPlayerParty[pokemonIndex], 57);
    if(hp == 0 || slotId == pokemonIndex || GetMonData(&gPlayerParty[pokemonIndex], 58) == hp)
    {
        sub_81617B8(taskId);
        return;
    }
    ...
    PlaySE(1);
    sub_81B1F18(taskId, slotId, -1, GetMonData(&gPlayerParty[slotId], 58)/5, sub_816166C);
}

static void sub_816166C(u8 taskId)
{
    PlaySE(1);
    sub_81B1F18(taskId, gUnknown_0203CEC8.unkA, 1, GetMonData(&gPlayerParty[gUnknown_0203CEC8.slotId], 58)/5, sub_81616C0);
}
...
static void sub_8161724(u8 taskId)
{
    ...
    ClearStdWindowAndFrameToTransparent(0x6, 0);
