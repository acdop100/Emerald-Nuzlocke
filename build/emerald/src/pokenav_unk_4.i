...
# 9 "src/pokenav_unk_4.c" 2
# 1 "include/menu.h" 1
# 10 "src/pokenav_unk_4.c" 2
...
# 15 "src/pokenav_unk_4.c" 2
# 1 "include/sprite.h" 1
# 16 "src/pokenav_unk_4.c" 2
...
# 18 "src/pokenav_unk_4.c" 2
# 1 "include/task.h" 1
# 19 "src/pokenav_unk_4.c" 2
# 1 "include/text.h" 1
# 20 "src/pokenav_unk_4.c" 2
...
s16 Sin2(u16 angle);
s16 Cos2(u16 angle);
# 22 "src/pokenav_unk_4.c" 2
# 1 "include/window.h" 1
# 23 "src/pokenav_unk_4.c" 2
# 1 "include/constants/game_stat.h" 1
# 24 "src/pokenav_unk_4.c" 2
# 1 "include/constants/region_map_sections.h" 1
# 25 "src/pokenav_unk_4.c" 2
# 1 "include/constants/songs.h" 1
# 26 "src/pokenav_unk_4.c" 2
# 1 "include/constants/species.h" 1
# 27 "src/pokenav_unk_4.c" 2
...
static void sub_81CBD78(struct Pokenav4Struct *state)
{
    ...
    FillWindowPixelBuffer(state->unk10, ((1) | ((1) << 4)));
    PutWindowTilemap(state->unk10);
    FillWindowPixelBuffer(state->unk12, ((1) | ((1) << 4)));
...
static void sub_81CBEF8(struct Pokenav4Struct *state, int arg1)
{
    ...
    FillWindowPixelBuffer(state->unk10, ((1) | ((1) << 4)));
    AddTextPrinterParameterized(state->unk10, 7, mapName, x, 1, 0, ((void *)0));
}
...
static void sub_81CBF60(struct Pokenav4Struct *state)
{
    ...
    for (i = 0; i < 3; i++)
    {
        ...
        AddTextPrinterParameterized(state->unk12, 7, gUnknown_086227E8[messageId], 16, i * 16 + 1, 0xFF, ((void *)0));
    }
...
static void sub_81CC058(struct Pokenav4Struct *state)
{
    ...
    FillWindowPixelBuffer(state->unk14, ((1) | ((1) << 4)));
...
{
    AddTextPrinterParameterized(state->unk14, 1, gUnknown_086227F4, 32, 1, 1, ((void *)0));
}
...
{
    AddTextPrinterParameterized(state->unk14, 1, gText_TrainerCloseBy, 0, 1, 1, ((void *)0));
}
...
static void sub_81CC158(struct Pokenav4Struct *state)
{
    ...
    AddTextPrinterParameterized(state->unk14, 1, str, 32, 1, speed, ((void *)0));
}
...
static void sub_81CC39C(struct Pokenav4Struct *state)
{
    ...
    if (trainerId >= 0)
    {
        DecompressPicFromTable(&gTrainerFrontPicTable[trainerId], state->unk1828, 0);
