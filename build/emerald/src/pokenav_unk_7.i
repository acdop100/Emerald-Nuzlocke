...
# 16 "src/pokenav_unk_7.c" 2
# 1 "include/text.h" 1
# 17 "src/pokenav_unk_7.c" 2
...
u32 sub_81CE6BC(s32 state)
{
    ...
    case 1:
        ...
        return 1;
    case 2:
        if (IsDma3ManagerBusyWithBgCopy_() == 1)
            return 2;
        return 1;
    }
