# 1 "src/unk_pokedex_area_screen_helper.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "src/unk_pokedex_area_screen_helper.c"
...
# 2 "src/unk_pokedex_area_screen_helper.c" 2
# 1 "include/main.h" 1
...
# 3 "src/unk_pokedex_area_screen_helper.c" 2
# 1 "include/menu.h" 1
...
# 4 "src/unk_pokedex_area_screen_helper.c" 2
# 1 "include/bg.h" 1
...
# 5 "src/unk_pokedex_area_screen_helper.c" 2
# 1 "include/alloc.h" 1
# 15 "include/alloc.h"
extern u8 gHeap[];
...
# 6 "src/unk_pokedex_area_screen_helper.c" 2
...
# 7 "src/unk_pokedex_area_screen_helper.c" 2
# 1 "include/unk_pokedex_area_screen_helper.h" 1
...
# 8 "src/unk_pokedex_area_screen_helper.c" 2

__attribute__((section("ewram_data"))) u8 *gUnknown_0203CF28 = ((void *)0);
...
void sub_81C4D70(const struct UnkStruct_1C4D70 *template)
{
    ...
    CpuSet(gUnknown_0861D140, &gPlttBufferUnfaded[0x70], 0x04000000 | ((0x60)/(32/8) & 0x1FFFFF));
...
void sub_81C4EB4(void)
{
    if (gUnknown_0203CF28 != ((void *)0))
    {
        { Free(gUnknown_0203CF28); gUnknown_0203CF28 = ((void *)0); };
    }
}
