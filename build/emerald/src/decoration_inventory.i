...
# 6 "src/decoration_inventory.c" 2
...
# 7 "src/decoration_inventory.c" 2





__attribute__((section("ewram_data"))) struct DecorationInventory gDecorationInventories[8] = {};
# 25 "src/decoration_inventory.c"
void SetDecorationInventoriesPointers(void)
{
    { gDecorationInventories[0].items = gSaveBlock1Ptr->decorDesk; gDecorationInventories[0].size = sizeof(gSaveBlock1Ptr->decorDesk);};
    { gDecorationInventories[1].items = gSaveBlock1Ptr->decorChair; gDecorationInventories[1].size = sizeof(gSaveBlock1Ptr->decorChair);};
    { gDecorationInventories[2].items = gSaveBlock1Ptr->decorPlant; gDecorationInventories[2].size = sizeof(gSaveBlock1Ptr->decorPlant);};
    { gDecorationInventories[3].items = gSaveBlock1Ptr->decorOrnament; gDecorationInventories[3].size = sizeof(gSaveBlock1Ptr->decorOrnament);};
    { gDecorationInventories[4].items = gSaveBlock1Ptr->decorMat; gDecorationInventories[4].size = sizeof(gSaveBlock1Ptr->decorMat);};
    { gDecorationInventories[5].items = gSaveBlock1Ptr->decorPoster; gDecorationInventories[5].size = sizeof(gSaveBlock1Ptr->decorPoster);};
    { gDecorationInventories[6].items = gSaveBlock1Ptr->decorDoll; gDecorationInventories[6].size = sizeof(gSaveBlock1Ptr->decorDoll);};
    { gDecorationInventories[7].items = gSaveBlock1Ptr->decorCushion; gDecorationInventories[7].size = sizeof(gSaveBlock1Ptr->decorCushion);};
...
static void ClearDecorationInventory(u8 idx)
{
    ...
    {
        gDecorationInventories[idx].items[i] = 0;
    }
}
...
s8 GetFirstEmptyDecorSlot(u8 idx)
{
    ...
    {
        if (gDecorationInventories[idx].items[i] == 0)
        {
            return i;
        }
    }
