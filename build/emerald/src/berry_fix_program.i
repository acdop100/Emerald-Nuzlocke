...
static void berry_fix_gpu_set(void)
{
    ...
    InitBgsFromTemplates(0, gUnknown_08618108, (size_t)(sizeof(gUnknown_08618108) / sizeof((gUnknown_08618108)[0])));
    ChangeBgX(0, 0, 0);
    ChangeBgY(0, 0, 0);
    ChangeBgX(1, 0, 0);
    ChangeBgY(1, 0, 0);
    ...
    left = (0x78 - width) / 2;
    AddTextPrinterParameterized3(2, 0, left, 3, sUnknown_0861815B, 0xFF, sUnknown_08617E9B);

    width = GetStringWidth(0, sUnknown_08617E8D, 0);
    left = (0x78 - width) / 2 + 0x78;
    AddTextPrinterParameterized3(2, 0, left, 3, sUnknown_0861815B, 0xFF, sUnknown_08617E8D);

    width = GetStringWidth(0, sUnknown_08617E8D, 0);
    left = (0x70 - width) / 2;
    AddTextPrinterParameterized3(3, 0, left, 0, sUnknown_0861815B, 0xFF, sUnknown_08617E8D);

    width = GetStringWidth(1, sUnknown_08617E78, 0);
    left = (0xD0 - width) / 2;
    AddTextPrinterParameterized3(0, 1, left, 2, sUnknown_08618158, 0xFF, sUnknown_08617E78);
...
static void berry_fix_text_print(int scene)
{
    ...
    LZ77UnCompVram(gUnknown_08618178[scene][0], (void *)(0x6000000 + (0x4000 * (1))));
    LZ77UnCompVram(gUnknown_08618178[scene][1], (void *)(0x6000000 + (0x800 * (31))));
    CpuSet(gUnknown_08618178[scene][2], (void *)0x5000000, 0x04000000 | ((0x100)/(32/8) & 0x1FFFFF));
    ShowBg(0);
    ShowBg(1);
}
