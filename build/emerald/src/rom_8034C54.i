...
# 2 "src/rom_8034C54.c" 2
# 1 "include/rom_8034C54.h" 1
...
static __attribute__((section("ewram_data"))) struct UnkStruct1 *gUnknown_02022E10 = {0};
...
bool32 sub_8034C54(u32 count)
{
    ...
    if (gUnknown_02022E10->array == ((void *)0))
    {
    ...
    for (i = 0; i < count; i++)
    {
        gUnknown_02022E10->array[i].isActive = 0;
...
void sub_8034CC8(void)
{
    if (gUnknown_02022E10 != ((void *)0))
    {
        ...
        { Free(gUnknown_02022E10); gUnknown_02022E10 = ((void *)0); };
    }
}
...
bool32 sub_8034D14(u32 id, s32 arg1, const struct UnkStruct3 *arg2)
{
    ...
    gUnknown_02022E10->array[id].isActive = 1;
...
void sub_80353DC(u32 id)
{
    ...
    gUnknown_02022E10->array[id].isActive = 0;
}
