...
static void TrainerApproachPlayer(struct EventObject *trainerObj, u8 range)
{
    ...
    task->data[3] = range;
    task->data[7] = gApproachingTrainers[gNoOfApproachingTrainers].eventObjectId;
}
...
static void Task_RunTrainerSeeFuncList(u8 taskId)
{
    ...
    struct EventObject *trainerObj = &gEventObjects[task->data[7]];
