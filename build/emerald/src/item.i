...
__attribute__((section("ewram_data"))) struct BagPocket gBagPockets[POCKETS_COUNT] = {0};
...
bool8 CheckBagHasItem(u16 itemId, u16 count)
{
    ...
    if (ItemId_GetPocket(itemId) == 0)
        return 0;
    if (InBattlePyramid() || FlagGet(0x4004) == 1)
...
bool8 RemoveBagItem(u16 itemId, u16 count)
{
    ...
    if (ItemId_GetPocket(itemId) == POCKET_NONE || itemId == 0)
        return 0;
    ...
    else
    {
        ...
        {
            VarSet(0x40EE, VarGet(0x40EE) | 0x200);
