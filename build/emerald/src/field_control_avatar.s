...
.L56:
	.align	2, 0
.L55:
	.word	EventScript_PlayerPCMale
	.word	EventScript_PlayerPCFemale
	.word	EventScript_SecretBasePC
	.word	EventScript_RecordMixingSecretBasePC
...
.Lfe9:
	...
	.align	2, 0
	.type	 GetInteractedEventObjectScript,function
	.thumb_func
...
.L95:
	.word	gSpecialVar_LastTalked
.Lfe10:
	.size	 GetInteractedEventObjectScript,.Lfe10-GetInteractedEventObjectScript
	.align	2, 0
...
.L173:
	.align	2, 0
.L172:
	.word	SkyPillar_Outside_EventScript_2393F9
.L137:
	add	r0, r5, #0
...
.L177:
	.align	2, 0
.L176:
	.word	Route110_TrickHouseEntrance_EventScript_26A22A
.L140:
	add	r0, r5, #0
...
.L209:
	.align	2, 0
.L208:
	.word	EventScript_SecretBaseSandOrnament
.L157:
	add	r0, r5, #0
...
.L211:
	.align	2, 0
.L210:
	.word	EventScript_SecretBaseShieldOrToyTV
.L158:
	add	r0, r5, #0
...
.L260:
	.align	2, 0
.L259:
	.word	BattleFrontier_BattlePyramidEmptySquare_EventScript_252BE8
.L249:
	add	r0, r4, #0
...
.L283:
	.align	2, 0
.L282:
	.word	UnusualWeather_EventScript_EndEventAndCleanup_1
.L266:
...
.L285:
	.align	2, 0
.L284:
	.word	IslandCave_EventScript_238EAF
.L267:
...
.L287:
	.align	2, 0
.L286:
	.word	MauvilleCity_EventScript_1DF7BA
.L268:
...
.L289:
	.align	2, 0
.L288:
	.word	Route119_EventScript_1F49EC
.L269:
...
.L291:
	.align	2, 0
.L290:
	.word	LittlerootTown_ProfessorBirchsLab_EventScript_1FA4D6
.L270:
...
.L293:
	.align	2, 0
.L292:
	.word	RustboroCity_Gym_EventScript_21307B
.L271:
...
.L295:
	.align	2, 0
.L294:
	.word	MossdeepCity_SpaceCenter_2F_EventScript_224175
.L263:
...
.L297:
	.align	2, 0
.L296:
	.word	SSTidalCorridor_EventScript_23C050
.L274:
...
.Lfe39:
	...
	.align	2, 0
	.globl	GetEventObjectScriptPointerPlayerFacing
	.type	 GetEventObjectScriptPointerPlayerFacing,function
	.thumb_func
GetEventObjectScriptPointerPlayerFacing:
	push	{r4, r5, lr}
	add	sp, sp, #-0x8
	...
	bx	r1
.Lfe40:
	.size	 GetEventObjectScriptPointerPlayerFacing,.Lfe40-GetEventObjectScriptPointerPlayerFacing
	.align	2, 0
