...
static bool32 TryWriteTrainerHill_r(struct EReaderTrainerHillSet *arg0, struct Unk81D3998 *buffer2)
{
    ...
    buffer2->checksum = CalcByteArraySum((u8 *)buffer2->unk_008, sizeof(struct Unk81D3998) - ((size_t)&((struct Unk81D3998 *)0)->unk_008));
...
{
    if (TryReadSpecialSaveSection(30, arg1) != 1)
        return 0;
...
static int unref_sub_81D3B54(int arg0, u32 *arg1)
{
    ...
    while (1)
    {
        ...
        var1 = sub_81D3D70(1, arg0, arg1, ((void *)0));
...
static int unref_sub_81D3BE8(u32 *arg0)
{
    ...
    while (1)
    {
        ...
        var1 = sub_81D3D70(0, 0, ((void *)0), arg0);
        gUnknown_030012E4 = var1;
        if ((gUnknown_030012E4 & 0x13) == 0x10)
        {
            result = 0;
