...
static const struct Landmark Landmark_FlowerShop = {LandmarkName_FlowerShop, ((0x500 + 0x356 + 0xA) + 0x3C)};
static const struct Landmark Landmark_PetalburgWoods = {LandmarkName_PetalburgWoods, -1};
static const struct Landmark Landmark_MrBrineysCottage = {LandmarkName_MrBrineysCottage, ((0x500 + 0x356 + 0xA) + 0x3D)};
static const struct Landmark Landmark_AbandonedShip = {LandmarkName_AbandonedShip, ((0x500 + 0x356 + 0xA) + 0x3E)};
static const struct Landmark Landmark_SeashoreHouse = {LandmarkName_SeashoreHouse, ((0x500 + 0x356 + 0xA) + 0x3F)};
...
static const struct Landmark Landmark_NewMauville = {LandmarkName_NewMauville, ((0x500 + 0x356 + 0xA) + 0x40)};
static const struct Landmark Landmark_TrickHouse = {LandmarkName_TrickHouse, ((0x500 + 0x356 + 0xA) + 0x42)};
static const struct Landmark Landmark_OldLadysRestShop = {LandmarkName_OldLadysRestShop, ((0x500 + 0x356 + 0xA) + 0x41)};
static const struct Landmark Landmark_Desert = {LandmarkName_Desert, -1};
static const struct Landmark Landmark_WinstrateFamily = {LandmarkName_WinstrateFamily, ((0x500 + 0x356 + 0xA) + 0x43)};
static const struct Landmark Landmark_CableCar = {LandmarkName_CableCar, -1};
static const struct Landmark Landmark_GlassWorkshop = {LandmarkName_GlassWorkshop, ((0x500 + 0x356 + 0xA) + 0x44)};
...
static const struct Landmark Landmark_TunnelersRestHouse = {LandmarkName_TunnelersRestHouse, ((0x500 + 0x356 + 0xA) + 0x5A)};
static const struct Landmark Landmark_RusturfTunnel = {LandmarkName_RusturfTunnel, -1};
static const struct Landmark Landmark_PokemonDayCare = {LandmarkName_PokemonDayCare, ((0x500 + 0x356 + 0xA) + 0x46)};
...
static const struct Landmark Landmark_SeafloorCavern = {LandmarkName_SeafloorCavern, ((0x500 + 0x356 + 0xA) + 0x47)};
...
static const struct Landmark Landmark_LanettesHouse = {LandmarkName_LanettesHouse, ((0x500 + 0x356 + 0xA) + 0x45)};
static const struct Landmark Landmark_FieryPath = {LandmarkName_FieryPath, ((0x500 + 0x356 + 0xA) + 0x4A)};
static const struct Landmark Landmark_JaggedPass = {LandmarkName_JaggedPass, -1};
static const struct Landmark Landmark_BerryMastersHouse = {LandmarkName_BerryMastersHouse, ((0x500 + 0x356 + 0xA) + 0x63)};
static const struct Landmark Landmark_IslandCave = {LandmarkName_IslandCave, ((0x500 + 0x356 + 0xA) + 0x55)};
static const struct Landmark Landmark_DesertRuins = {LandmarkName_DesertRuins, ((0x500 + 0x356 + 0xA) + 0x56)};
static const struct Landmark Landmark_ScorchedSlab = {LandmarkName_ScorchedSlab, ((0x500 + 0x356 + 0xA) + 0x58)};
static const struct Landmark Landmark_AncientTomb = {LandmarkName_AncientTomb, ((0x500 + 0x356 + 0xA) + 0x59)};
static const struct Landmark Landmark_SealedChamber = {LandmarkName_SealedChamber, ((0x500 + 0x356 + 0xA) + 0x5C)};
static const struct Landmark Landmark_FossilManiacsHouse = {LandmarkName_FossilManiacsHouse, ((0x500 + 0x356 + 0xA) + 0x57)};
static const struct Landmark Landmark_HuntersHouse = {LandmarkName_HuntersHouse, ((0x500 + 0x356 + 0xA) + 0x5B)};
static const struct Landmark Landmark_SkyPillar = {LandmarkName_SkyPillar, ((0x500 + 0x356 + 0xA) + 0x5E)};
static const struct Landmark Landmark_MirageTower = {LandmarkName_MirageTower, 0x78};
static const struct Landmark Landmark_AlteringCave = {LandmarkName_AlteringCave, ((0x500 + 0x356 + 0xA) + 0x7D)};
static const struct Landmark Landmark_DesertUnderpass = {LandmarkName_DesertUnderpass, ((0x500 + 0x356 + 0xA) + 0x7E)};
static const struct Landmark Landmark_TrainerHill = {LandmarkName_TrainerHill, ((0x500 + 0x356 + 0xA) + 0x82)};
