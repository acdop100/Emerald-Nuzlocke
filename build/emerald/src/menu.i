...
s8 sub_81993D8(void)
{
    ...
    else if ((gMain.newAndRepeatedKeys & ((0x0010 | 0x0020 | 0x0040 | 0x0080))) == 0x0020 || sub_812210C() == 1)
    {
        PlaySE(5);
        sub_8199134(-1, 0);
        return -2;
    }
    else if ((gMain.newAndRepeatedKeys & ((0x0010 | 0x0020 | 0x0040 | 0x0080))) == 0x0010 || sub_812210C() == 2)
    {
        PlaySE(5);
        sub_8199134(1, 0);
        return -2;
    ...
    *(string++) = color + 1;
    ...
    switch (a0)
    {
        ...
        case 3:
            ...
            break;
        case 4:
            for (curFlag = ((0x500 + 0x356 + 0xA) + 7), flagCount = 0, endOfString = string + 1; curFlag <= ((0x500 + 0x356 + 0xA) + 0xE); curFlag++)
            {
                if (FlagGet(curFlag))
                    flagCount++;
            }
