...
{
    if ((u16)gBattleAnimArgs[0x7] == 0xFFFF)
    {
...
void sub_81075EC(struct Sprite *sprite)
{
    ...
    retArg = gBattleAnimArgs[0x7];
    if (gBattleAnimArgs[0x7] > 127)
    {
...
{
    gTasks[taskId].data[0] = gBattleAnimArgs[0];
    gBattleAnimArgs[0x7] = 0;
    gTasks[taskId].func = sub_81076F4;
}

void sub_81076F4(u8 taskId)
{
    gBattleAnimArgs[0x7] = (gBattleAnimArgs[0x7] + 3) & 0xFF;
    if (--gTasks[taskId].data[0] == 0)
        DestroyAnimVisualTask(taskId);
}
