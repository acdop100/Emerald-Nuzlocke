...
{
    [0] = {0x23, 0x46, 0x23, 0x01},
    [1] = {0x04, 0x09, 0x05, 0x00},
    [2] = {0x15, 0x2a, 0x15, 0x01},
    [3] = {0x1c, 0x38, 0x1c, 0x01},
    [4] = {0x15, 0x2a, 0x15, 0x01},
    [5] = {0x1c, 0x8c, 0x38, 0x01},
    [6] = {0x15, 0x46, 0x23, 0x00},
};
...
static void sub_81A17A0(void)
{
    ...
    case 1:
        sub_813A878(0);
        VarSet(0x4000, gSaveBlock2Ptr->frontier.field_CA8);
        break;
    case 4:
        sub_813A878(0);
        VarSet(0x4000, gSaveBlock2Ptr->frontier.field_CA8);
    ...
    case 1:
        ...
        else
        {
            if (gBattleTypeFlags & 0x1000000)
                ...
                FrontierSpeechToString(gSaveBlock2Ptr->apprentices[trainerId - 400].easyChatWords);
        }
        break;
    case 2:
        if (trainerId == 500)
...
u8 GetPlayerSymbolCountForFacility(u8 facility)
{
    return FlagGet(((0x500 + 0x356 + 0xA) + 0x64) + facility * 2)
         + FlagGet(((0x500 + 0x356 + 0xA) + 0x65) + facility * 2);
}
...
static void sub_81A3B64(void)
{
    ...
    if (challengeNum != 0)
        challengeNum--;
    if (challengeNum >= (size_t)(sizeof(gUnknown_086118B4) / sizeof((gUnknown_086118B4)[0])))
        challengeNum = (size_t)(sizeof(gUnknown_086118B4) / sizeof((gUnknown_086118B4)[0])) - 1;
...
static void sub_81A3D58(void)
{
    ...
    if (GetPlayerSymbolCountForFacility(facility) == 0)
        FlagSet(((0x500 + 0x356 + 0xA) + 0x64) + facility * 2);
    else
        FlagSet(((0x500 + 0x356 + 0xA) + 0x65) + facility * 2);
}
...
static void sub_81A457C(void)
{
    SetFrontierBrainEventObjGfx(VarGet(0x40CF));
}
...
static void Print1PRecord(s32 position, s32 x, s32 y, struct RankingHall1P *hallRecord, s32 hallFacilityId)
{
    ...
    if (hallRecord->winStreak)
    {
        ...
        AddTextPrinterParameterized(gRecordsWindowId, 1, gStringVar4, GetStringRightAlignXOffset(1, gHallFacilityToRecordsText[hallFacilityId], 0xC8), (8 * (y + 5 * position)) + 1, 0xFF, ((void *)0));
    }
}
...
static void Print2PRecord(s32 position, s32 x, s32 y, struct RankingHall2P *hallRecord)
{
    ...
    if (hallRecord->winStreak)
    {
        ...
        AddTextPrinterParameterized(gRecordsWindowId, 1, gStringVar4, GetStringRightAlignXOffset(1, gHallFacilityToRecordsText[9], 0xC8), (8 * (y + 5 * position)) + 1, 0xFF, ((void *)0));
    }
}
...
static void PrintHallRecords(s32 hallFacilityId, s32 lvlMode)
{
    ...
    AddTextPrinterParameterized(gRecordsWindowId, 1, gLevelModeText[lvlMode], x, 1, 0xFF, ((void *)0));
    if (hallFacilityId == 9)
    {
        gSaveBlock2Ptr->frontier.opponentName[0][7] = 0xFF;
        gSaveBlock2Ptr->frontier.opponentName[1][7] = 0xFF;
...
{
    s32 facility = VarGet(0x40CF);
    VarSet(0x4010, sFacilityToBrainEventObjGfx[facility][0]);
}
# 2523 "src/frontier_util.c"
__attribute__((naked))
void CreateFrontierBrainPokemon(void)
{
