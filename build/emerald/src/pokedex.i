...
static __attribute__((section("ewram_data"))) u16 gUnknown_02039B50 = 0;
static __attribute__((section("ewram_data"))) u8 gUnknown_02039B52 = 0;
...
struct PokedexView
{
    struct PokedexListItem pokedexList[386];
    u16 unk608;
    u8 unk60A_1:1;
    u8 unk60A_2:1;
    u8 unk60B;
...
static const struct PokedexOption gDexSearchTypeOptions[] =
{
    ...
    {gText_DexEmptyString, gTypeNames[0x00]},
    {gText_DexEmptyString, gTypeNames[0x01]},
    {gText_DexEmptyString, gTypeNames[0x02]},
    {gText_DexEmptyString, gTypeNames[0x03]},
    {gText_DexEmptyString, gTypeNames[0x04]},
    {gText_DexEmptyString, gTypeNames[0x05]},
    {gText_DexEmptyString, gTypeNames[0x06]},
    {gText_DexEmptyString, gTypeNames[0x07]},
    {gText_DexEmptyString, gTypeNames[0x08]},
    {gText_DexEmptyString, gTypeNames[0x0a]},
    {gText_DexEmptyString, gTypeNames[0x0b]},
    {gText_DexEmptyString, gTypeNames[0x0c]},
    {gText_DexEmptyString, gTypeNames[0x0d]},
    {gText_DexEmptyString, gTypeNames[0x0e]},
    {gText_DexEmptyString, gTypeNames[0x0f]},
    {gText_DexEmptyString, gTypeNames[0x10]},
    {gText_DexEmptyString, gTypeNames[0x11]},
    {((void *)0), ((void *)0)},
};
...
static const struct UnknownStruct1 gUnknown_0856EFC8[] =
{
    ...
    {gDexSearchTypeOptions, 10, 11, 0x12},
    {gDexSearchTypeOptions, 12, 13, 0x12},
...
void sub_80BBA78(u8 taskId)
{
    ...
    else
    {
        ...
        else if ((gMain.newAndRepeatedKeys & 0x0080) && sPokedexView->menuCursorPos <= 2)
        {
            sPokedexView->menuCursorPos++;
            PlaySE(5);
        }
...
static void CreateMonListEntry(u8 direction, u16 b, u16 c)
{
    ...
    switch (direction)
    {
        ...
        default:
            ...
            for (i = 0; i <= 10; i++)
            {
                if (_b < 0 || _b >= 386 || sPokedexView->pokedexList[_b].dexNum == 0xFFFF)
                {
...
static void CreateMonDexNum(u16 a, u8 left, u8 top, u16 unused)
{
    ...
    text[2] = 0xA1 + r6 / 100;
    text[3] = 0xA1 + (r6 % 100) / 10;
    text[4] = 0xA1 + (r6 % 100) % 10;
...
bool8 sub_80BD404(u8 a, u8 b, u8 c)
{
    ...
    if (sPokedexView->unk62E)
    {
        ...
        switch (a)
        {
            case 1:
                ...
                SetGpuReg(0x1a, sPokedexView->initialVOffset + sPokedexView->unk632 * 16 - foo);
    ...
    {
        SetGpuReg(0x1a, sPokedexView->initialVOffset + sPokedexView->unk630 * 16);
        return 1;
    }
}
...
u8 sub_80BD930(void)
{
    ...
    else if ((gMain.newKeys & 0x0080) && r4 < sPokedexView->pokemonListCount - 1)
    {
        r2 = r4;
        ...
        case 6:
            {
                ...
                BeginNormalPaletteFade(~r3, 0, 16, 0, ((0) | ((0) << 5) | ((0) << 10)));
...
void sub_80C0BF0(u8 windowId, const u8* str, u8 left, u8 top)
{
    ...
    for (i = 0; i < 11; i++)
        str2[i] = 0x00;
    for (count = 0; str[count] != 0x00 && count < 11; count++)
        ;
    for (i = 0; i < count; i++)
...
u16 CreateMonSpriteFromNationalDexNumber(u16 nationalNum, s16 x, s16 y, u16 paletteSlot)
{
    ...
    return CreateMonPicSprite_HandleDeoxys(nationalNum, 8, sub_80C0E68(nationalNum), 1, x, y, paletteSlot, 0xFFFF);
}
...
void sub_80C2294(u8 taskId)
{
    ...
    sub_80C267C();
    for (i = 0, j = *r7; i < 6 && r6[j].title != ((void *)0); i++, j++)
