...
static const u16 sBerryMasterWifePhrases[][2] = {
    {(0x9 << 9) | 0x40, (0x3 << 9) | 0x28},
    {(0x3 << 9) | 0x1f, (0x11 << 9) | 0x4},
    {(0xa << 9) | 0x22, ((0x0 << 9) | 407)},
    {(0x2 << 9) | 0x15, ((0x0 << 9) | 408)},
    {(0x11 << 9) | 0x7, (0x2 << 9) | 0x49},
};
...
static int sub_811BF20(void)
{
    return sub_811BC7C(sMysteryGiftPhrase, (size_t)(sizeof(sMysteryGiftPhrase) / sizeof((sMysteryGiftPhrase)[0]))) == 0;
}
...
static u16 sub_811BF40(void)
{
    ...
    for (i = 0; i < 5; i++)
    {
        if (!sub_811BC7C(sBerryMasterWifePhrases[i], (size_t)(sizeof(*sBerryMasterWifePhrases) / sizeof((*sBerryMasterWifePhrases)[0]))))
            return i + 1;
    }
...
static void sub_811D758(void)
{
    ...
    for (i = 0; i < (size_t)(sizeof(sUnknown_08597C90) / sizeof((sUnknown_08597C90)[0])); i++)
        sub_811D028(2, 1, sUnknown_08597C90[i], 10, 97 + i * 16, 0xFF, ((void *)0));
}
...
static bool8 sub_811EA28(u8 groupId)
{
    ...
    {
    case 0x14:
        return FlagGet(((0x500 + 0x356 + 0xA) + 6));
    case 0x11:
    case 0x12:
    case 0x13:
        return FlagGet(((0x500 + 0x356 + 0xA) + 4));
    case 0x15:
        return sub_811F0F8();
    default:
        return 1;
