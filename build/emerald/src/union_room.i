...
__attribute__((section("ewram_data"))) u8 gUnknown_02022C20[12] = {};
...
__attribute__((section("ewram_data"))) struct UnkLinkRfuStruct_02022B14Substruct gUnknown_02022C38 = {};
__attribute__((section("ewram_data"))) u16 gUnknown_02022C3C = 0;
__attribute__((section("ewram_data"))) u8 gUnknown_02022C3E = 0;
__attribute__((section("ewram_data"))) struct TradeUnkStruct gUnknown_02022C40 = {};
...
__attribute__((aligned(4))) const u8 gText_EmptyString[] = _("");
__attribute__((aligned(4))) const u8 gText_Colon[] = _(":");
__attribute__((aligned(4))) const u8 gText_UnkCtrlCodeF907[] = _("{ID}");
__attribute__((aligned(4))) const u8 gText_PleaseStartOver[] = _("Please start over from the beginning.");
__attribute__((aligned(4))) const u8 gText_WirelessSearchCanceled[] = _("The WIRELESS COMMUNICATION\nSYSTEM search has been canceled.");
__attribute__((aligned(4))) const u8 unref_text_union_room_0[] = _("Awaiting communication\nfrom another player.");
__attribute__((aligned(4))) const u8 gText_AwaitingCommunication[] = _("{STR_VAR_1}! Awaiting\ncommunication from another player.");
__attribute__((aligned(4))) const u8 gText_AwaitingLink[] = _("{STR_VAR_1}! Awaiting link!\nPress START when everyone's ready.");
__attribute__((aligned(4))) const u8 gJPText_SingleBattle[] = _("シングルバトルを かいさいする");
__attribute__((aligned(4))) const u8 gJPText_DoubleBattle[] = _("ダブルバトルを かいさいする");
__attribute__((aligned(4))) const u8 gJPText_MultiBattle[] = _("マルチバトルを かいさいする");
__attribute__((aligned(4))) const u8 gJPText_TradePokemon[] = _("ポケモンこうかんを かいさいする");
__attribute__((aligned(4))) const u8 gJPText_Chat[] = _("チャットを かいさいする");
__attribute__((aligned(4))) const u8 gJPText_DistWonderCard[] = _("ふしぎなカードをくばる");
__attribute__((aligned(4))) const u8 gJPText_DistWonderNews[] = _("ふしぎなニュースをくばる");
__attribute__((aligned(4))) const u8 unref_text_union_room_1[] = _("ふしぎなできごとを かいさいする");
__attribute__((aligned(4))) const u8 gJPText_HoldPokemonJump[] = _("なわとびを かいさいする");
__attribute__((aligned(4))) const u8 gJPText_HoldBerryCrush[] = _("きのみマッシャーを かいさいする");
__attribute__((aligned(4))) const u8 gJPText_HoldBerryPicking[] = _("きのみどりを かいさいする");
__attribute__((aligned(4))) const u8 gJPText_HoldSpinTrade[] = _("ぐるぐるこうかんを かいさいする");
__attribute__((aligned(4))) const u8 gJPText_HoldSpinShop[] = _("ぐるぐるショップを かいさいする");
...
__attribute__((aligned(4))) const u8 gUnknown_082EDBC4[] = _("{B_BUTTON}CANCEL");
__attribute__((aligned(4))) const u8 unref_text_union_room_2[] = _("ため\nさんかしゃ ぼしゅうちゅう です！");
__attribute__((aligned(4))) const u8 gUnknown_082EDBE8[] = _("{STR_VAR_2} contacted you for\n{STR_VAR_1}. Accept?");
__attribute__((aligned(4))) const u8 gUnknown_082EDC0C[] = _("{STR_VAR_2} contacted you.\nWill you share {STR_VAR_1}?");
__attribute__((aligned(4))) const u8 gUnknown_082EDC34[] = _("{STR_VAR_2} contacted you.\nAdd to the members?");
__attribute__((aligned(4))) const u8 gUnknown_082EDC5C[] = _("{STR_VAR_1}!\nAre these members OK?");
__attribute__((aligned(4))) const u8 gUnknown_082EDC78[] = _("Cancel {STR_VAR_1} MODE\nwith these members?");
__attribute__((aligned(4))) const u8 gUnknown_082EDC9C[] = _("An “OK” was sent\nto {STR_VAR_1}.");
__attribute__((aligned(4))) const u8 gUnknown_082EDCB4[] = _("The other TRAINER doesn't appear\nto be available now…\p");
__attribute__((aligned(4))) const u8 gUnknown_082EDCEC[] = _("You can't transmit with a TRAINER\nwho is too far away.\p");
__attribute__((aligned(4))) const u8 gUnknown_082EDD24[] = _("The other TRAINER(S) is/are not\nready yet.\p");
...
__attribute__((aligned(4))) const u8 gUnknown_082EDD58[] = _("The {STR_VAR_1} MODE with\nthese members will be canceled.{PAUSE 60}");
__attribute__((aligned(4))) const u8 gUnknown_082EDD8C[] = _("There is a member who can no\nlonger remain available.\p");
...
__attribute__((aligned(4))) const u8 gUnknown_082EDDCC[] = _("The other TRAINER appears\nunavailable…\p");
__attribute__((aligned(4))) const u8 gUnknown_082EDDF4[] = _("{STR_VAR_1} sent back an “OK”!");
__attribute__((aligned(4))) const u8 gUnknown_082EDE0C[] = _("{STR_VAR_1} OK'd your registration as\na member.");
__attribute__((aligned(4))) const u8 gUnknown_082EDE34[] = _("{STR_VAR_1} replied, “No…”\p");
__attribute__((aligned(4))) const u8 gUnknown_082EDE48[] = _("{STR_VAR_1}!\nAwaiting other members!");
__attribute__((aligned(4))) const u8 gUnknown_082EDE64[] = _("Quit being a member?");
__attribute__((aligned(4))) const u8 gUnknown_082EDE7C[] = _("You stopped being a member.\p");
...
__attribute__((aligned(4))) const u8 gUnknown_082EDEC4[] = _("The WIRELESS COMMUNICATION\nSYSTEM link has been established.");
__attribute__((aligned(4))) const u8 gUnknown_082EDF04[] = _("The WIRELESS COMMUNICATION\nSYSTEM link has been dropped…");
__attribute__((aligned(4))) const u8 gUnknown_082EDF40[] = _("The link with your friend has been\ndropped…");
__attribute__((aligned(4))) const u8 gUnknown_082EDF6C[] = _("{STR_VAR_1} replied, “No…”");
...
__attribute__((aligned(4))) const u8 gUnknown_082EDFA8[] = _("Do you want the {STR_VAR_2}\nMODE?");
__attribute__((aligned(4))) const u8 gUnknown_082EDFC4[] = _("Do you want the {STR_VAR_2}\nMODE?");
...
__attribute__((aligned(4))) const u8 unref_text_union_room_3[] = _("Communicating…\nPlease wait.");
__attribute__((aligned(4))) const u8 gUnknown_082EE004[] = _("Awaiting {STR_VAR_1}'s response about\nthe trade…");
__attribute__((aligned(4))) const u8 gUnknown_082EE02C[] = _("Communicating{PAUSE 15}.{PAUSE 15}.{PAUSE 15}.{PAUSE 15}.{PAUSE 15}.\n{PAUSE 15}.{PAUSE 15}.{PAUSE 15}.{PAUSE 15}.{PAUSE 15}.{PAUSE 15}.{PAUSE 15}.{PAUSE 15}.{PAUSE 15}.{PAUSE 15}.{PAUSE 15}.{PAUSE 15}.{PAUSE 15}.{PAUSE 15}.{PAUSE 15}.{PAUSE 15}.{PAUSE 15}.{PAUSE 15}.");
__attribute__((aligned(4))) const u8 gUnknown_082EE098[] = _("Communicating with {STR_VAR_1}{PAUSE 15}.{PAUSE 15}.{PAUSE 15}.\n{PAUSE 15}.{PAUSE 15}.{PAUSE 15}.{PAUSE 15}.{PAUSE 15}.{PAUSE 15}.{PAUSE 15}.{PAUSE 15}.{PAUSE 15}.{PAUSE 15}.{PAUSE 15}.{PAUSE 15}.{PAUSE 15}.{PAUSE 15}.{PAUSE 15}.{PAUSE 15}.{PAUSE 15}.{PAUSE 15}.");
__attribute__((aligned(4))) const u8 gUnknown_082EE104[] = _("Please wait a while{PAUSE 15}.{PAUSE 15}.{PAUSE 15}.{PAUSE 15}.{PAUSE 15}.{PAUSE 15}.\n{PAUSE 15}.{PAUSE 15}.{PAUSE 15}.{PAUSE 15}.{PAUSE 15}.{PAUSE 15}.{PAUSE 15}.{PAUSE 15}.{PAUSE 15}.{PAUSE 15}.{PAUSE 15}.{PAUSE 15}.{PAUSE 15}.{PAUSE 15}.{PAUSE 15}.{PAUSE 15}.{PAUSE 15}.{PAUSE 15}.");
...
__attribute__((aligned(4))) const u8 gUnknown_082EE188[] = _("Hiya! Is there something that you\nwanted to do?");
__attribute__((aligned(4))) const u8 gUnknown_082EE1B8[] = _("Hello!\nWould you like to do something?");
__attribute__((aligned(4))) const u8 gUnknown_082EE1E0[] = _("{STR_VAR_1}: Hiya, we meet again!\nWhat are you up for this time?");
__attribute__((aligned(4))) const u8 gUnknown_082EE218[] = _("{STR_VAR_1}: Oh! {PLAYER}, hello!\nWould you like to do something?");
...
__attribute__((aligned(4))) const u8 gUnknown_082EE25C[] = _("Want to do something?");
__attribute__((aligned(4))) const u8 gUnknown_082EE274[] = _("Would you like to do something?");
__attribute__((aligned(4))) const u8 gUnknown_082EE294[] = _("{STR_VAR_1}: What would you like to\ndo now?");
__attribute__((aligned(4))) const u8 unref_text_union_room_4[] = _("{STR_VAR_1}: Want to do anything else?");
...
__attribute__((aligned(4))) const u8 gUnknown_082EE2E8[] = _("Somebody has contacted you.{PAUSE 60}");
__attribute__((aligned(4))) const u8 gUnknown_082EE308[] = _("{STR_VAR_1} has contacted you.{PAUSE 60}");
...
__attribute__((aligned(4))) const u8 gUnknown_082EE32C[] = _("Awaiting a response from\nthe other TRAINER…");
__attribute__((aligned(4))) const u8 gUnknown_082EE358[] = _("Awaiting a response from\n{STR_VAR_1}…");
...
__attribute__((aligned(4))) const u8 gUnknown_082EE380[] = _("The other TRAINER showed\nyou their TRAINER CARD.\pWould you like to show your\nTRAINER CARD?");
__attribute__((aligned(4))) const u8 gUnknown_082EE3DC[] = _("The other TRAINER challenges you\nto battle.\pWill you accept the battle\nchallenge?");
__attribute__((aligned(4))) const u8 gUnknown_082EE430[] = _("The other TRAINER invites you\nto chat.\pWill you accept the chat\ninvitation?");
__attribute__((aligned(4))) const u8 gUnknown_082EE47C[] = _("There is an offer to trade your\nregistered Lv. {SPECIAL_F7 0x00} {SPECIAL_F7 0x01}\pin exchange for a\nLv. {SPECIAL_F7 0x02} {SPECIAL_F7 0x03}.\pWill you accept this trade\noffer?");
__attribute__((aligned(4))) const u8 gUnknown_082EE4F0[] = _("There is an offer to trade your\nregistered EGG.\lWill you accept this trade offer?");
__attribute__((aligned(4))) const u8 gUnknown_082EE544[] = _("The chat has been dropped.\p");
__attribute__((aligned(4))) const u8 gUnknown_082EE560[] = _("You declined the offer.\p");
__attribute__((aligned(4))) const u8 gUnknown_082EE57C[] = _("You declined the offer.\p");
__attribute__((aligned(4))) const u8 gUnknown_082EE598[] = _("The chat was ended.\p");
...
__attribute__((aligned(4))) const u8 gUnknown_082EE5C0[] = _("Oh, hey! We're in a chat right now.\nWant to join us?");
__attribute__((aligned(4))) const u8 gUnknown_082EE5F8[] = _("{STR_VAR_1}: Hey, {PLAYER}!\nWe're having a chat right now.\lWant to join us?");
__attribute__((aligned(4))) const u8 gUnknown_082EE638[] = _("Oh, hi! We're having a chat now.\nWould you like to join us?");
__attribute__((aligned(4))) const u8 gUnknown_082EE674[] = _("{STR_VAR_1}: Oh, hi, {PLAYER}!\nWe're having a chat now.\lWould you like to join us?");
...
__attribute__((aligned(4))) const u8 gUnknown_082EE6C8[] = _("……\nThe TRAINER appears to be busy…\p");
__attribute__((aligned(4))) const u8 gUnknown_082EE6EC[] = _("A battle, huh?\nAll right, just give me some time.");
__attribute__((aligned(4))) const u8 gUnknown_082EE720[] = _("You want to chat, huh?\nSure, just wait a little.");
__attribute__((aligned(4))) const u8 gUnknown_082EE754[] = _("Sure thing! As my “Greetings,”\nhere's my TRAINER CARD.");
__attribute__((aligned(4))) const u8 gUnknown_082EE78C[] = _("A battle? Of course, but I need\ntime to get ready.");
__attribute__((aligned(4))) const u8 gUnknown_082EE7C0[] = _("Did you want to chat?\nOkay, but please wait a moment.");
__attribute__((aligned(4))) const u8 gUnknown_082EE7F8[] = _("As my introduction, I'll show you\nmy TRAINER CARD.");
...
__attribute__((aligned(4))) const u8 unref_text_union_room_5[] = _("You want to chat, huh?\nSure, just wait a little.");
__attribute__((aligned(4))) const u8 gUnknown_082EE880[] = _("Thanks for waiting!\nLet's get our battle started!{PAUSE 60}");
__attribute__((aligned(4))) const u8 gUnknown_082EE8B8[] = _("All right!\nLet's chat!{PAUSE 60}");
__attribute__((aligned(4))) const u8 gUnknown_082EE8D4[] = _("Sorry I made you wait!\nLet's get started!{PAUSE 60}");
__attribute__((aligned(4))) const u8 gUnknown_082EE904[] = _("Sorry I made you wait!\nLet's chat.{PAUSE 60}");
__attribute__((aligned(4))) const u8 gUnknown_082EE92C[] = _("The trade will be started.{PAUSE 60}");
__attribute__((aligned(4))) const u8 gUnknown_082EE94C[] = _("The battle will be started.{PAUSE 60}");
__attribute__((aligned(4))) const u8 gUnknown_082EE96C[] = _("Entering the chat…{PAUSE 60}");
...
__attribute__((aligned(4))) const u8 gUnknown_082EE9B4[] = _("Sorry! My POKéMON don't seem to\nbe feeling too well right now.\lLet me battle you another time.\p");
__attribute__((aligned(4))) const u8 gUnknown_082EEA14[] = _("I'm terribly sorry, but my POKéMON\naren't feeling well…\pLet's battle another time.\p");
...
__attribute__((aligned(4))) const u8 gUnknown_082EEA70[] = _("Huh? My TRAINER CARD…\nWhere'd it go now?\lSorry! I'll show you another time!\p");
__attribute__((aligned(4))) const u8 gUnknown_082EEAC0[] = _("Oh? Now where did I put my\nTRAINER CARD?…\lSorry! I'll show you later!\p");
...
__attribute__((aligned(4))) const u8 gUnknown_082EEB10[] = _("If you want to do something with\nme, just give me a shout!\p");
__attribute__((aligned(4))) const u8 gUnknown_082EEB4C[] = _("If you want to do something with\nme, don't be shy.\p");
...
__attribute__((aligned(4))) const u8 gUnknown_082EEB88[] = _("Whoops! Sorry, but I have to do\nsomething else.\lAnother time, okay?\p");
__attribute__((aligned(4))) const u8 gUnknown_082EEBD0[] = _("If you want to battle, you need\ntwo POKéMON that are below\lLv. 30.\p");
__attribute__((aligned(4))) const u8 gUnknown_082EEC14[] = _("For a battle, you need two\nPOKéMON that are below Lv. 30.\p");
__attribute__((aligned(4))) const u8 gUnknown_082EEC50[] = _("Oh, all right.\nCome see me anytime, okay?\p");
__attribute__((aligned(4))) const u8 gUnknown_082EEC7C[] = _("Oh…\nPlease come by anytime.\p");
...
__attribute__((aligned(4))) const u8 gUnknown_082EECA4[] = _("Oh, sorry!\nI just can't right this instant.\lLet's chat another time.\p");
__attribute__((aligned(4))) const u8 gUnknown_082EECEC[] = _("Oh, I'm sorry.\nI have too much to do right now.\lLet's chat some other time.\p");
...
__attribute__((aligned(4))) const u8 gUnknown_082EED44[] = _("Whoa!\nI can tell you're pretty tough!\p");
__attribute__((aligned(4))) const u8 gUnknown_082EED6C[] = _("You used that move?\nThat's good strategy!\p");
__attribute__((aligned(4))) const u8 gUnknown_082EED98[] = _("Way to go!\nThat was an eye-opener!\p");
__attribute__((aligned(4))) const u8 gUnknown_082EEDBC[] = _("Oh! How could you use that\nPOKéMON in that situation?\p");
__attribute__((aligned(4))) const u8 gUnknown_082EEDF4[] = _("That POKéMON…\nIt's been raised really well!\p");
__attribute__((aligned(4))) const u8 gUnknown_082EEE24[] = _("That's it!\nThis is the right move now!\p");
__attribute__((aligned(4))) const u8 gUnknown_082EEE4C[] = _("That's awesome!\nYou can battle that way?\p");
__attribute__((aligned(4))) const u8 gUnknown_082EEE78[] = _("You have exquisite timing for\nswitching POKéMON!\p");
...
__attribute__((aligned(4))) const u8 gUnknown_082EEECC[] = _("Oh, I see!\nThis is educational!\p");
__attribute__((aligned(4))) const u8 gUnknown_082EEEF0[] = _("Don't say anything funny anymore!\nI'm sore from laughing!\p");
__attribute__((aligned(4))) const u8 gUnknown_082EEF2C[] = _("Oh?\nSomething like that happened.\p");
__attribute__((aligned(4))) const u8 gUnknown_082EEF50[] = _("Hmhm… What?\nSo is this what you're saying?\p");
__attribute__((aligned(4))) const u8 gUnknown_082EEF7C[] = _("Is that right?\nI didn't know that.\p");
__attribute__((aligned(4))) const u8 gUnknown_082EEFA0[] = _("Ahaha!\nWhat is that about?\p");
__attribute__((aligned(4))) const u8 gUnknown_082EEFBC[] = _("Yes, that's exactly it!\nThat's what I meant.\p");
__attribute__((aligned(4))) const u8 gUnknown_082EEFEC[] = _("In other words…\nYes! That's right!\p");
...
__attribute__((aligned(4))) const u8 gUnknown_082EF030[] = _("I'm just showing my TRAINER CARD\nas my way of greeting.\p");
__attribute__((aligned(4))) const u8 gUnknown_082EF06C[] = _("I hope I get to know you better!\p");
__attribute__((aligned(4))) const u8 gUnknown_082EF090[] = _("We're showing each other our\nTRAINER CARDS to get acquainted.\p");
__attribute__((aligned(4))) const u8 gUnknown_082EF0D0[] = _("Glad to meet you.\nPlease don't be a stranger!\p");
...
__attribute__((aligned(4))) const u8 gUnknown_082EF110[] = _("Yeahah!\nI really wanted this POKéMON!\p");
__attribute__((aligned(4))) const u8 gUnknown_082EF138[] = _("Finally, a trade got me that\nPOKéMON I'd wanted a long time.\p");
__attribute__((aligned(4))) const u8 gUnknown_082EF178[] = _("I'm trading POKéMON right now.\p");
__attribute__((aligned(4))) const u8 gUnknown_082EF198[] = _("I finally got that POKéMON I\nwanted in a trade!\p");
...
__attribute__((aligned(4))) const u8 gUnknown_082EF1EC[] = _("{STR_VAR_1} checked the\nTRADING BOARD.\p");
__attribute__((aligned(4))) const u8 gUnknown_082EF20C[] = _("Welcome to the TRADING BOARD.\pYou may register your POKéMON\nand offer it up for a trade.\pWould you like to register one of\nyour POKéMON?");
__attribute__((aligned(4))) const u8 gUnknown_082EF298[] = _("This TRADING BOARD is used for\noffering a POKéMON for a trade.\pAll you need to do is register a\nPOKéMON for a trade.\pAnother TRAINER may offer a party\nPOKéMON in return for the trade.\pWe hope you will register POKéMON\nand trade them with many, many\lother TRAINERS.\pWould you like to register one of\nyour POKéMON?");
__attribute__((aligned(4))) const u8 unref_text_union_room_6[] = _("We have registered your POKéMON for\ntrade on the TRADING BOARD.\pThank you for using this service!\p");
__attribute__((aligned(4))) const u8 unref_text_union_room_7[] = _("Nobody has registered any POKéMON\nfor trade on the TRADING BOARD.\p\n");
__attribute__((aligned(4))) const u8 gUnknown_082EF47C[] = _("Please choose the type of POKéMON\nthat you would like in the trade.\n");
__attribute__((aligned(4))) const u8 gUnknown_082EF4C4[] = _("Which of your party POKéMON will\nyou offer in trade?\p");
__attribute__((aligned(4))) const u8 gUnknown_082EF4FC[] = _("Registration has been canceled.\p");
__attribute__((aligned(4))) const u8 gUnknown_082EF520[] = _("Registration has been completed.\p");
__attribute__((aligned(4))) const u8 gUnknown_082EF544[] = _("The trade has been canceled.\p");
__attribute__((aligned(4))) const u8 gUnknown_082EF564[] = _("Cancel the registration of your\nLv. {STR_VAR_2} {STR_VAR_1}?");
__attribute__((aligned(4))) const u8 gUnknown_082EF590[] = _("Cancel the registration of your\nEGG?");
__attribute__((aligned(4))) const u8 gUnknown_082EF5B8[] = _("The registration has been canceled.\p");
__attribute__((aligned(4))) const u8 unref_text_union_room_8[] = _("TRAINERS wishing to make a trade\nwill be listed.");
__attribute__((aligned(4))) const u8 unref_text_union_room_9[] = _("Please choose the TRAINER with whom\nyou would like to trade POKéMON.");
__attribute__((aligned(4))) const u8 gUnknown_082EF65C[] = _("Would you like to ask {STR_VAR_1} to\nmake a trade?");
__attribute__((aligned(4))) const u8 unref_text_union_room_10[] = _("Awaiting a response from\nthe other TRAINER…");
__attribute__((aligned(4))) const u8 unref_text_union_room_11[] = _("You have not registered a POKéMON\nfor trading.\p");
__attribute__((aligned(4))) const u8 gUnknown_082EF6E4[] = _("You don't have a {STR_VAR_2}-type\nPOKéMON that {STR_VAR_1} wants.\p");
__attribute__((aligned(4))) const u8 gUnknown_082EF718[] = _("You don't have an EGG that\n{STR_VAR_1} wants.\p");
__attribute__((aligned(4))) const u8 gUnknown_082EF740[] = _("{STR_VAR_1} can't make a trade for\nyour POKéMON right now.\p");
__attribute__((aligned(4))) const u8 gUnknown_082EF774[] = _("You can't make a trade for\n{STR_VAR_1}'s POKéMON right now.\p");
...
__attribute__((aligned(4))) const u8 gUnknown_082EF7B0[] = _("Your trade offer was rejected.\p");
__attribute__((aligned(4))) const u8 gUnknown_082EF7D0[] = _("EGG TRADE");
__attribute__((aligned(4))) const u8 gUnknown_082EF7DC[] = _("{DPAD_UPDOWN}CHOOSE  {A_BUTTON}JOIN  {B_BUTTON}CANCEL");
__attribute__((aligned(4))) const u8 gUnknown_082EF7F8[] = _("Please choose a TRAINER.");
__attribute__((aligned(4))) const u8 gUnknown_082EF814[] = _("Please choose a TRAINER for\na SINGLE BATTLE.");
__attribute__((aligned(4))) const u8 gUnknown_082EF844[] = _("Please choose a TRAINER for\na DOUBLE BATTLE.");
__attribute__((aligned(4))) const u8 gUnknown_082EF874[] = _("Please choose the LEADER\nfor a MULTI BATTLE.");
__attribute__((aligned(4))) const u8 gUnknown_082EF8A4[] = _("Please choose the TRAINER to\ntrade with.");
__attribute__((aligned(4))) const u8 gUnknown_082EF8D0[] = _("Please choose the TRAINER who is\nsharing WONDER CARDS.");
__attribute__((aligned(4))) const u8 gUnknown_082EF908[] = _("Please choose the TRAINER who is\nsharing WONDER NEWS.");
__attribute__((aligned(4))) const u8 gUnknown_082EF940[] = _("Jump with mini POKéMON!\nPlease choose the LEADER.");
__attribute__((aligned(4))) const u8 gUnknown_082EF974[] = _("BERRY CRUSH!\nPlease choose the LEADER.");
__attribute__((aligned(4))) const u8 gUnknown_082EF99C[] = _("DODRIO BERRY-PICKING!\nPlease choose the LEADER.");
__attribute__((aligned(4))) const u8 gUnknown_082EF9CC[] = _("BERRY BLENDER!\nPlease choose the LEADER.");
__attribute__((aligned(4))) const u8 gUnknown_082EF9F8[] = _("RECORD CORNER!\nPlease choose the LEADER.");
__attribute__((aligned(4))) const u8 gUnknown_082EFA24[] = _("COOLNESS CONTEST!\nPlease choose the LEADER.");
__attribute__((aligned(4))) const u8 gUnknown_082EFA50[] = _("BEAUTY CONTEST!\nPlease choose the LEADER.");
__attribute__((aligned(4))) const u8 gUnknown_082EFA7C[] = _("CUTENESS CONTEST!\nPlease choose the LEADER.");
__attribute__((aligned(4))) const u8 gUnknown_082EFAA8[] = _("SMARTNESS CONTEST!\nPlease choose the LEADER.");
__attribute__((aligned(4))) const u8 gUnknown_082EFAD8[] = _("TOUGHNESS CONTEST!\nPlease choose the LEADER.");
__attribute__((aligned(4))) const u8 gUnknown_082EFB08[] = _("BATTLE TOWER LEVEL 50!\nPlease choose the LEADER.");
__attribute__((aligned(4))) const u8 gUnknown_082EFB3C[] = _("BATTLE TOWER OPEN LEVEL!\nPlease choose the LEADER.");
...
__attribute__((aligned(4))) const u8 gUnknown_082EFBC8[] = _("Searching for a WIRELESS\nCOMMUNICATION SYSTEM. Wait...");
__attribute__((aligned(4))) const u8 unref_text_union_room_12[] = _("For a DOUBLE BATTLE, you must have\nat least two POKéMON.\p");
__attribute__((aligned(4))) const u8 gUnknown_082EFC3C[] = _("Awaiting {STR_VAR_1}'s response…");
__attribute__((aligned(4))) const u8 gUnknown_082EFC54[] = _("{STR_VAR_1} has been asked to register\nyou as a member. Please wait.");
__attribute__((aligned(4))) const u8 gUnknown_082EFC90[] = _("Awaiting a response from the\nWIRELESS COMMUNICATION SYSTEM.");
__attribute__((aligned(4))) const u8 unref_text_union_room_13[] = _("Please wait for other TRAINERS to\ngather and get ready.");
__attribute__((aligned(4))) const u8 gUnknown_082EFD04[] = _("No CARDS appear to be shared \nright now.");
__attribute__((aligned(4))) const u8 gUnknown_082EFD30[] = _("No NEWS appears to be shared\nright now.");
...
__attribute__((aligned(4))) const u8 gUnknown_082EFD60[] = _("BATTLE");
__attribute__((aligned(4))) const u8 gUnknown_082EFD68[] = _("CHAT");
__attribute__((aligned(4))) const u8 gUnknown_082EFD70[] = _("GREETINGS");
__attribute__((aligned(4))) const u8 gUnknown_082EFD7C[] = _("EXIT");
__attribute__((aligned(4))) const u8 gUnknown_082EFD84[] = _("EXIT");
__attribute__((aligned(4))) const u8 gUnknown_082EFD8C[] = _("INFO");
__attribute__((aligned(4))) const u8 gUnknown_082EFD94[] = _("NAME{CLEAR_TO 0x3C}WANTED{CLEAR_TO 0x6E}OFFER{CLEAR_TO 0xC6}LV.");
__attribute__((aligned(4))) const u8 gUnknown_082EFDB0[] = _("SINGLE BATTLE");
__attribute__((aligned(4))) const u8 gUnknown_082EFDC0[] = _("DOUBLE BATTLE");
__attribute__((aligned(4))) const u8 gUnknown_082EFDD0[] = _("MULTI BATTLE");
__attribute__((aligned(4))) const u8 gUnknown_082EFDE0[] = _("POKéMON TRADES");
__attribute__((aligned(4))) const u8 gUnknown_082EFDF0[] = _("CHAT");
__attribute__((aligned(4))) const u8 gUnknown_082EFDF8[] = _("CARDS");
__attribute__((aligned(4))) const u8 gUnknown_082EFE00[] = _("WONDER CARDS");
__attribute__((aligned(4))) const u8 gUnknown_082EFE10[] = _("WONDER NEWS");
__attribute__((aligned(4))) const u8 gUnknown_082EFE1C[] = _("POKéMON JUMP");
__attribute__((aligned(4))) const u8 gUnknown_082EFE2C[] = _("BERRY CRUSH");
__attribute__((aligned(4))) const u8 gUnknown_082EFE38[] = _("BERRY-PICKING");
__attribute__((aligned(4))) const u8 gUnknown_082EFE48[] = _("SEARCH");
__attribute__((aligned(4))) const u8 gUnknown_082EFE50[] = _("BERRY BLENDER");
__attribute__((aligned(4))) const u8 gUnknown_082EFE60[] = _("RECORD CORNER");
__attribute__((aligned(4))) const u8 gUnknown_082EFE70[] = _("COOL CONTEST");
__attribute__((aligned(4))) const u8 gUnknown_082EFE80[] = _("BEAUTY CONTEST");
__attribute__((aligned(4))) const u8 gUnknown_082EFE90[] = _("CUTE CONTEST");
__attribute__((aligned(4))) const u8 gUnknown_082EFEA0[] = _("SMART CONTEST");
__attribute__((aligned(4))) const u8 gUnknown_082EFEB0[] = _("TOUGH CONTEST");
__attribute__((aligned(4))) const u8 gUnknown_082EFEC0[] = _("BATTLE TOWER LV. 50");
__attribute__((aligned(4))) const u8 gUnknown_082EFED4[] = _("BATTLE TOWER OPEN LEVEL");
__attribute__((aligned(4))) const u8 gUnknown_082EFEEC[] = _("It's a NORMAL CARD.");
__attribute__((aligned(4))) const u8 gUnknown_082EFF00[] = _("It's a BRONZE CARD!");
__attribute__((aligned(4))) const u8 gUnknown_082EFF14[] = _("It's a COPPER CARD!");
__attribute__((aligned(4))) const u8 gUnknown_082EFF28[] = _("It's a SILVER CARD!");
__attribute__((aligned(4))) const u8 gUnknown_082EFF3C[] = _("It's a GOLD CARD!");
...
__attribute__((aligned(4))) const u8 gUnknown_082EFF64[] = _("This is {SPECIAL_F7 0x00} {SPECIAL_F7 0x01}'s\nTRAINER CARD…\l{SPECIAL_F7 0x02}\pPOKéDEX: {SPECIAL_F7 0x03}\nTIME:    {SPECIAL_F7 0x04}:{SPECIAL_F7 0x05}\p");
__attribute__((aligned(4))) const u8 gUnknown_082EFFA4[] = _("BATTLES: WINS: {SPECIAL_F7 0x00}  LOSSES: {SPECIAL_F7 0x02}\nTRADES: {SPECIAL_F7 0x03}\p“{SPECIAL_F7 0x04} {SPECIAL_F7 0x05}\n{SPECIAL_F7 0x06} {SPECIAL_F7 0x07}”\p");
__attribute__((aligned(4))) const u8 gUnknown_082EFFDC[] = _("{SPECIAL_F7 0x01}: Glad to have met you!{PAUSE 60}");
__attribute__((aligned(4))) const u8 gUnknown_082EFFFC[] = _("{SPECIAL_F7 0x01}: Glad to meet you!{PAUSE 60}");
...
__attribute__((aligned(4))) const u8 gUnknown_082F0020[] = _("Finished checking {SPECIAL_F7 0x01}'s\nTRAINER CARD.{PAUSE 60}");
...
const struct ListMenuItem gUnknown_082F029C[] = {
    { gTypeNames[0x00], 0x00 },
    { gTypeNames[0x0a], 0x0a },
    { gTypeNames[0x0b], 0x0b },
    { gTypeNames[0x0d], 0x0d },
    { gTypeNames[0x0c], 0x0c },
    { gTypeNames[0x0f], 0x0f },
    { gTypeNames[0x04], 0x04 },
    { gTypeNames[0x05], 0x05 },
    { gTypeNames[0x02], 0x02 },
    { gTypeNames[0x0e], 0x0e },
    { gTypeNames[0x01], 0x01 },
    { gTypeNames[0x03], 0x03 },
    { gTypeNames[0x06], 0x06 },
    { gTypeNames[0x07], 0x07 },
    { gTypeNames[0x10], 0x10 },
    { gTypeNames[0x08], 0x08 },
    { gTypeNames[0x11], 0x11 },
    { gUnknown_082EFD7C, 0x12 }
};
...
void sub_8013F90(u8 taskId)
{
    ...
    case 3:
        if (GetBlockReceivedStatus() == 3)
        {
            memcpy(gUnknown_020321C0, gBlockRecvBuffer[GetMultiplayerId() ^ 1], sizeof(struct MailStruct) * 6);
            ResetBlockReceivedFlags();
...
bool32 sub_80180A0(u32 monId, struct TradeUnkStruct *arg1)
{
    arg1->playerSpecies = GetMonData(&gPlayerParty[monId], 65);
    arg1->playerLevel = GetMonData(&gPlayerParty[monId], 56);
    arg1->playerPersonality = GetMonData(&gPlayerParty[monId], 0);
    if (arg1->playerSpecies == 412)
    {
        return 1;
    }
    else
...
void sub_80180E8(u32 monId, struct TradeUnkStruct *arg1)
{
    arg1->species = GetMonData(&gPlayerParty[monId], 65);
    arg1->level = GetMonData(&gPlayerParty[monId], 56);
    arg1->personality = GetMonData(&gPlayerParty[monId], 0);
}
