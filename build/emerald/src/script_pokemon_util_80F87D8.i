...
# 1 "include/sprite.h" 1
# 27 "src/script_pokemon_util_80F87D8.c" 2
...
u8 GiveMonArtistRibbon(void)
{
     ...
     && gUnknown_02039F08[gContestPlayerMonIndex] >= 800)
    {
        ...
        if (GetRibbonCount(&gPlayerParty[gContestMonPartyIndex]) > 4)
            sub_80EE4DC(&gPlayerParty[gContestMonPartyIndex], 70);
...
{
    if ((gLinkContestFlags & (1 << 0)) && gNumLinkContestPlayers == 4 && !(gLinkContestFlags & (1 << 1)))
