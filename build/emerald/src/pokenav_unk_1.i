...
# 4 "src/pokenav_unk_1.c" 2
# 1 "include/main.h" 1
# 5 "src/pokenav_unk_1.c" 2
# 1 "include/sound.h" 1
...
# 6 "src/pokenav_unk_1.c" 2
# 1 "include/constants/songs.h" 1
# 7 "src/pokenav_unk_1.c" 2
...
static u8 GetPokenavMainMenuType(void)
{
    ...
    {
        retVal = 1;
        if (FlagGet(((0x500 + 0x356 + 0xA) + 0x3B)))
            retVal = 2;
    }
