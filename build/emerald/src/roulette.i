...
static void sub_81405CC(void)
{
    ...
    case 6:
        ...
        AddTextPrinterParameterized(gUnknown_0203AB8C, 1, gUnknown_082A5B89, 0, 1, 0xFF, ((void *)0));
...
static void sub_8140914(u8 taskId)
{
    ...
    DrawStdWindowFrame(gUnknown_0203AB8C, 0);
    AddTextPrinterParameterized(gUnknown_0203AB8C, 1, gUnknown_082A5C13, 0, 1, 0xFF, 0);
    CopyWindowToVram(gUnknown_0203AB8C, 3);
...
static void sub_814189C(u8 taskId)
{
    ...
    case 2:
        if (gTasks[taskId].data[2] == 12)
        {
            PlayFanfare(389);
            DrawStdWindowFrame(gUnknown_0203AB8C, 0);
            AddTextPrinterParameterized(gUnknown_0203AB8C, 1, gUnknown_082A5BD7, 0, 1, 0xFF, ((void *)0));
            CopyWindowToVram(gUnknown_0203AB8C, 3);
        }
        else
        {
            PlayFanfare(390);
            DrawStdWindowFrame(gUnknown_0203AB8C, 0);
            AddTextPrinterParameterized(gUnknown_0203AB8C, 1, gUnknown_082A5BCB, 0, 1, 0xFF, ((void *)0));
            CopyWindowToVram(gUnknown_0203AB8C, 3);
        }
        break;
    case 0:
    default:
        m4aSongNumStart(32);
        DrawStdWindowFrame(gUnknown_0203AB8C, 0);
        AddTextPrinterParameterized(gUnknown_0203AB8C, 1, gUnknown_082A5BE0, 0, 1, 0xFF, ((void *)0));
        CopyWindowToVram(gUnknown_0203AB8C, 3);
        break;
    }
    gTasks[taskId].data[1] = 0;
...
static void sub_8141B58(u8 taskId)
{
    ...
    if (gTasks[taskId].data[13] >= gUnknown_0203AB88->var19)
    {
        ...
        {
            DrawStdWindowFrame(gUnknown_0203AB8C, 0);
            AddTextPrinterParameterized(gUnknown_0203AB8C, 1, gUnknown_082A5C21, 0, 1, 0xFF, ((void *)0));
            CopyWindowToVram(gUnknown_0203AB8C, 3);
        ...
        {
            DrawStdWindowFrame(gUnknown_0203AB8C, 0);
            AddTextPrinterParameterized(gUnknown_0203AB8C, 1, gUnknown_082A5C61, 0, 1, 0xFF, ((void *)0));
            CopyWindowToVram(gUnknown_0203AB8C, 3);
    ...
    {
        DrawStdWindowFrame(gUnknown_0203AB8C, 0);
        AddTextPrinterParameterized(gUnknown_0203AB8C, 1, gUnknown_082A5C04, 0, 1, 0xFF, ((void *)0));
        CopyWindowToVram(gUnknown_0203AB8C, 3);
...
static void Task_Roulette_0(u8 taskId)
{
    ...
    if (gTasks[taskId].data[13] >= temp)
    {
        ...
        {
            DrawStdWindowFrame(0, 0);
            AddTextPrinterParameterized(0, 1, gUnknown_082A5B6B, 0, 1, 0xFF, ((void *)0));
            CopyWindowToVram(0, 3);
